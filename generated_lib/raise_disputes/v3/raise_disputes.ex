defmodule Adyen.RaiseDisputes.V3.RaiseDisputes do
  @moduledoc """
  ...
  @spec get_disputes(opts :: keyword) ::
          {:ok, [[Adyen.RaiseDisputes.V3.DisputeResponse.t()]]}
          | {:error, Adyen.RaiseDisputes.V3.DefaultErrorResponseEntity.t()}
  def get_disputes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.RaiseDisputes.V3.RaiseDisputes, :get_disputes},
      url: "/disputes",
      method: :get,
      query: query,
      response: [
        {200, [[{Adyen.RaiseDisputes.V3.DisputeResponse, :t}]]},
        {401, {Adyen.RaiseDisputes.V3.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.RaiseDisputes.V3.DefaultErrorResponseEntity, :t}},
        {422, {Adyen.RaiseDisputes.V3.DefaultErrorResponseEntity, :t}}
      ],
      opts: opts
    })
  end
  ...
  def get_disputes_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.RaiseDisputes.V3.RaiseDisputes, :get_disputes_id},
      url: "/disputes/#{id}",
      method: :get,
      response: [
        {200, {Adyen.RaiseDisputes.V3.DisputeResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_disputes_id(
          id :: String.t(),
          body :: Adyen.RaiseDisputes.V3.PatchableDisputeRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.RaiseDisputes.V3.DisputeResponse.t()}
          | {:error, Adyen.RaiseDisputes.V3.DefaultErrorResponseEntity.t()}
  def patch_disputes_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.RaiseDisputes.V3.RaiseDisputes, :patch_disputes_id},
      url: "/disputes/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.RaiseDisputes.V3.PatchableDisputeRequest, :t}}],
      response: [
        {200, {Adyen.RaiseDisputes.V3.DisputeResponse, :t}},
        {401, {Adyen.RaiseDisputes.V3.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.RaiseDisputes.V3.DefaultErrorResponseEntity, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_disputes(body :: Adyen.RaiseDisputes.V3.DisputeRequest.t(), opts :: keyword) ::
          {:ok, Adyen.RaiseDisputes.V3.DisputeResponse.t()}
          | {:error, Adyen.RaiseDisputes.V3.DefaultErrorResponseEntity.t()}
  def post_disputes(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.RaiseDisputes.V3.RaiseDisputes, :post_disputes},
      url: "/disputes",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.RaiseDisputes.V3.DisputeRequest, :t}}],
      response: [
        {200, {Adyen.RaiseDisputes.V3.DisputeResponse, :t}},
        {401, {Adyen.RaiseDisputes.V3.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.RaiseDisputes.V3.DefaultErrorResponseEntity, :t}},
