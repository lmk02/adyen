defmodule Adyen.RaiseDisputes.V1.DisputeAttachments do
  @moduledoc """
  ...
  @spec delete_disputes_dispute_id_attachments_attachment_id(
          ...
          opts :: keyword
        ) :: :ok | {:error, Adyen.RaiseDisputes.V1.DefaultErrorResponseEntity.t()}
  def delete_disputes_dispute_id_attachments_attachment_id(disputeId, attachmentId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.RaiseDisputes.V1.DisputeAttachments,
  ...
  @spec get_disputes_dispute_id_attachments(disputeId :: String.t(), opts :: keyword) ::
          {:ok, [Adyen.RaiseDisputes.V1.DisputeAttachment.t()]}
  ...
  def get_disputes_dispute_id_attachments(disputeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.RaiseDisputes.V1.DisputeAttachments, :get_disputes_dispute_id_attachments},
      url: "/disputes/#{disputeId}/attachments",
      method: :get,
      response: [
        {200, [{Adyen.RaiseDisputes.V1.DisputeAttachment, :t}]},
        {401, {Adyen.RaiseDisputes.V1.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.RaiseDisputes.V1.DefaultErrorResponseEntity, :t}},
        {422, {Adyen.RaiseDisputes.V1.DefaultErrorResponseEntity, :t}}
      ],
  ...
  **Content Types**: `application/json`
  ...
  @spec post_disputes_dispute_id_attachments(
          disputeId :: String.t(),
          body :: Adyen.RaiseDisputes.V1.DisputeAttachment.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.RaiseDisputes.V1.AttachDocumentResponse.t()}
          | {:error, Adyen.RaiseDisputes.V1.DefaultErrorResponseEntity.t()}
  def post_disputes_dispute_id_attachments(disputeId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.RaiseDisputes.V1.DisputeAttachments, :post_disputes_dispute_id_attachments},
      url: "/disputes/#{disputeId}/attachments",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.RaiseDisputes.V1.DisputeAttachment, :t}}],
      response: [
        {200, {Adyen.RaiseDisputes.V1.AttachDocumentResponse, :t}},
        {401, {Adyen.RaiseDisputes.V1.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.RaiseDisputes.V1.DefaultErrorResponseEntity, :t}},
        {422, {Adyen.RaiseDisputes.V1.DefaultErrorResponseEntity, :t}}
      ],
