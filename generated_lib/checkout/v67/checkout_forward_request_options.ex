defmodule Adyen.Checkout.V67.CheckoutForwardRequestOptions do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          dryRun: boolean | nil,
          networkToken: Adyen.Checkout.V67.CheckoutNetworkTokenOption.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      dryRun: :boolean,
      networkToken: {Adyen.Checkout.V67.CheckoutNetworkTokenOption, :t},
