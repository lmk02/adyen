defmodule Adyen.Checkout.V51.PaypalUpdateOrderRequest do
  ...
  @type t :: %__MODULE__{
          ...
          discountAmount: Adyen.Checkout.V51.Amount.t() | nil,
          paymentData: String.t() | nil,
          pspReference: String.t() | nil,
          sessionId: String.t() | nil,
          shippingAmount: Adyen.Checkout.V51.Amount.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      discountAmount: {Adyen.Checkout.V51.Amount, :t},
      paymentData: :string,
      pspReference: :string,
      sessionId: :string,
      shippingAmount: {Adyen.Checkout.V51.Amount, :t},
