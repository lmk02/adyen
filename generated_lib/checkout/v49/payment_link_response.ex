defmodule Adyen.Checkout.V49.PaymentLinkResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          billingAddress: Adyen.Checkout.V49.Address.t() | nil,
          blockedPaymentMethods: [String.t()] | nil,
          countryCode: String.t() | nil,
          deliverAt: DateTime.t() | nil,
          deliveryAddress: Adyen.Checkout.V49.Address.t() | nil,
          ...
          metadata: map | nil,
          platformChargebackLogic: Adyen.Checkout.V49.PlatformChargebackLogic.t() | nil,
          ...
          shopperName: Adyen.Checkout.V49.Name.t() | nil,
          shopperReference: String.t() | nil,
          showRemovePaymentMethodButton: boolean | nil,
          splits: [Adyen.Checkout.V49.Split.t()] | nil,
          status: String.t(),
          store: String.t() | nil,
          threeDS2RequestData: Adyen.Checkout.V49.CheckoutSessionThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      billingAddress: {Adyen.Checkout.V49.Address, :t},
      blockedPaymentMethods: [:string],
      countryCode: :string,
      deliverAt: {:string, "date-time"},
      deliveryAddress: {Adyen.Checkout.V49.Address, :t},
      description: :string,
      expiresAt: :string,
      ...
      metadata: :map,
      platformChargebackLogic: {Adyen.Checkout.V49.PlatformChargebackLogic, :t},
      ...
      shopperName: {Adyen.Checkout.V49.Name, :t},
      shopperReference: :string,
      showRemovePaymentMethodButton: :boolean,
      splits: [{Adyen.Checkout.V49.Split, :t}],
      status: {:enum, ["active", "completed", "expired", "paid", "paymentPending"]},
      store: :string,
      threeDS2RequestData: {Adyen.Checkout.V49.CheckoutSessionThreeDs2RequestData, :t},
