defmodule Adyen.Checkout.V49.ThreeDs2RequestFields do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          deviceRenderOptions: Adyen.Checkout.V49.DeviceRenderOptions.t() | nil,
          mcc: String.t() | nil,
          merchantName: String.t() | nil,
          messageVersion: String.t() | nil,
          notificationURL: String.t() | nil,
          sdkAppID: String.t() | nil,
          sdkEphemPubKey: Adyen.Checkout.V49.SDKEphemPubKey.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      deviceRenderOptions: {Adyen.Checkout.V49.DeviceRenderOptions, :t},
      mcc: :string,
      merchantName: :string,
      messageVersion: :string,
      notificationURL: :string,
      sdkAppID: :string,
      sdkEphemPubKey: {Adyen.Checkout.V49.SDKEphemPubKey, :t},
