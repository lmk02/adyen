defmodule Adyen.Checkout.V49.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: Adyen.Checkout.V49.Recurring.t() | nil,
          ...
          threeDS2RequestData: Adyen.Checkout.V49.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {Adyen.Checkout.V49.Recurring, :t},
      ...
      threeDS2RequestData: {Adyen.Checkout.V49.ThreeDs2RequestData, :t},
      totalsGroup: :string,
