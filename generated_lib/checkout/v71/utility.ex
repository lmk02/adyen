defmodule Adyen.Checkout.V71.Utility do
  ...
  **Content Types**: `application/json`
  ...
  @spec post_validate_shopper_id(
          ...
          | {:error, Adyen.Checkout.V71.CheckoutErrorResponseEntity.t()}
  def post_validate_shopper_id(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [
        ...
        {400, {Adyen.Checkout.V71.CheckoutErrorResponseEntity, :t}},
        {401, {Adyen.Checkout.V71.CheckoutErrorResponseEntity, :t}},
        {403, {Adyen.Checkout.V71.CheckoutErrorResponseEntity, :t}},
        {422, {Adyen.Checkout.V71.CheckoutErrorResponseEntity, :t}},
        {500, {Adyen.Checkout.V71.CheckoutErrorResponseEntity, :t}}
      ],
      opts: opts
    })
  end
