defmodule Adyen.Checkout.V71.AuthenticationData do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          threeDSRequestData: Adyen.Checkout.V71.ThreeDSRequestData.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      threeDSRequestData: {Adyen.Checkout.V71.ThreeDSRequestData, :t}
    ]
  end
end
