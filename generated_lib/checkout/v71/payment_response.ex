defmodule Adyen.Checkout.V71.PaymentResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          action:
            Adyen.Checkout.V71.CheckoutAwaitAction.t()
            | Adyen.Checkout.V71.CheckoutBankTransferAction.t()
            | Adyen.Checkout.V71.CheckoutDelegatedAuthenticationAction.t()
            | Adyen.Checkout.V71.CheckoutNativeRedirectAction.t()
            | Adyen.Checkout.V71.CheckoutQrCodeAction.t()
            | Adyen.Checkout.V71.CheckoutRedirectAction.t()
            | Adyen.Checkout.V71.CheckoutSDKAction.t()
            | Adyen.Checkout.V71.CheckoutThreeDs2Action.t()
            | Adyen.Checkout.V71.CheckoutVoucherAction.t()
            | nil,
