defmodule Adyen.Checkout.V71.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          deliveryAddress: Adyen.Checkout.V71.Address.t() | nil,
          ...
          paymentMethod: map,
          recurring: Adyen.Checkout.V71.Recurring.t() | nil,
          ...
          threeDS2RequestData: Adyen.Checkout.V71.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      deliveryAddress: {Adyen.Checkout.V71.Address, :t},
      ...
      paymentMethod: :map,
      recurring: {Adyen.Checkout.V71.Recurring, :t},
      ...
      threeDS2RequestData: {Adyen.Checkout.V71.ThreeDs2RequestData, :t},
