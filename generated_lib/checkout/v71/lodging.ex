defmodule Adyen.Checkout.V71.Lodging do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          folio: Adyen.Checkout.V71.Folio.t() | nil,
          ...
          rooms: [Adyen.Checkout.V71.Room.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      folio: {Adyen.Checkout.V71.Folio, :t},
      ...
      renterName: :string,
      rooms: [{Adyen.Checkout.V71.Room, :t}],
