defmodule Adyen.Checkout.V71.CarRental do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          noShow: boolean | nil,
          pickupInfo: Adyen.Checkout.V71.PickupInfo.t() | nil,
          ...
          rentalSurcharges: Adyen.Checkout.V71.RentalSurcharges.t() | nil,
          renterName: String.t(),
          returnInfo: Adyen.Checkout.V71.ReturnInfo.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      noShow: :boolean,
      pickupInfo: {Adyen.Checkout.V71.PickupInfo, :t},
      ...
      rentalSurcharges: {Adyen.Checkout.V71.RentalSurcharges, :t},
      renterName: :string,
      returnInfo: {Adyen.Checkout.V71.ReturnInfo, :t},
      taxExempt: :boolean
    ]
  end
end
