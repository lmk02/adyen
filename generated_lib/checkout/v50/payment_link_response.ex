defmodule Adyen.Checkout.V50.PaymentLinkResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          billingAddress: Adyen.Checkout.V50.Address.t() | nil,
          blockedPaymentMethods: [String.t()] | nil,
          countryCode: String.t() | nil,
          deliverAt: DateTime.t() | nil,
          deliveryAddress: Adyen.Checkout.V50.Address.t() | nil,
          ...
          metadata: map | nil,
          platformChargebackLogic: Adyen.Checkout.V50.PlatformChargebackLogic.t() | nil,
          ...
          shopperName: Adyen.Checkout.V50.Name.t() | nil,
          ...
          threeDS2RequestData: Adyen.Checkout.V50.CheckoutSessionThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      billingAddress: {Adyen.Checkout.V50.Address, :t},
      blockedPaymentMethods: [:string],
      countryCode: :string,
      deliverAt: {:string, "date-time"},
      deliveryAddress: {Adyen.Checkout.V50.Address, :t},
      description: :string,
      expiresAt: :string,
      ...
      metadata: :map,
      platformChargebackLogic: {Adyen.Checkout.V50.PlatformChargebackLogic, :t},
      ...
      shopperName: {Adyen.Checkout.V50.Name, :t},
      ...
      threeDS2RequestData: {Adyen.Checkout.V50.CheckoutSessionThreeDs2RequestData, :t},
