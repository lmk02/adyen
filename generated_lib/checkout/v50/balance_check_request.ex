defmodule Adyen.Checkout.V50.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: Adyen.Checkout.V50.Recurring.t() | nil,
          ...
          threeDS2RequestData: Adyen.Checkout.V50.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {Adyen.Checkout.V50.Recurring, :t},
      ...
      threeDS2RequestData: {Adyen.Checkout.V50.ThreeDs2RequestData, :t},
