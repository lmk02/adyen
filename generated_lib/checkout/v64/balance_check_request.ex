defmodule Adyen.Checkout.V64.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: Adyen.Checkout.V64.Recurring.t() | nil,
          ...
          threeDS2RequestData: Adyen.Checkout.V64.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {Adyen.Checkout.V64.Recurring, :t},
      ...
      threeDS2RequestData: {Adyen.Checkout.V64.ThreeDs2RequestData, :t},
