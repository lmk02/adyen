defmodule Adyen.Checkout.V53.CheckoutVoucherAction do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          initialAmount: Adyen.Checkout.V53.Amount.t() | nil,
          ...
          surcharge: Adyen.Checkout.V53.Amount.t() | nil,
          totalAmount: Adyen.Checkout.V53.Amount.t() | nil,
          type: String.t(),
          url: String.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      entity: :string,
      expiresAt: :string,
      initialAmount: {Adyen.Checkout.V53.Amount, :t},
      ...
      shopperEmail: :string,
      shopperName: :string,
      surcharge: {Adyen.Checkout.V53.Amount, :t},
      totalAmount: {Adyen.Checkout.V53.Amount, :t},
      type: {:const, "voucher"},
      url: :string
    ]
  end
