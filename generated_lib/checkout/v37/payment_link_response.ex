defmodule Adyen.Checkout.V37.PaymentLinkResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          applicationInfo: Adyen.Checkout.V37.ApplicationInfo.t() | nil,
          ...
          metadata: map | nil,
          platformChargebackLogic: Adyen.Checkout.V37.PlatformChargebackLogic.t() | nil,
          ...
          status: String.t(),
          store: String.t() | nil,
          threeDS2RequestData: Adyen.Checkout.V37.CheckoutSessionThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      amount: {Adyen.Checkout.V37.Amount, :t},
      applicationInfo: {Adyen.Checkout.V37.ApplicationInfo, :t},
      ...
      metadata: :map,
      platformChargebackLogic: {Adyen.Checkout.V37.PlatformChargebackLogic, :t},
      ...
      store: :string,
      threeDS2RequestData: {Adyen.Checkout.V37.CheckoutSessionThreeDs2RequestData, :t},
