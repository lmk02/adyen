defmodule Adyen.Checkout.V37.PixRecurring do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          minAmount: Adyen.Checkout.V37.Amount.t() | nil,
          originalPspReference: String.t() | nil,
          recurringAmount: Adyen.Checkout.V37.Amount.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      minAmount: {Adyen.Checkout.V37.Amount, :t},
      originalPspReference: :string,
      recurringAmount: {Adyen.Checkout.V37.Amount, :t},
