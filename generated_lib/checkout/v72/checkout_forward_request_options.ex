defmodule Adyen.Checkout.V72.CheckoutForwardRequestOptions do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          dryRun: boolean | nil,
          networkToken: Adyen.Checkout.V72.CheckoutNetworkTokenOption.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      dryRun: :boolean,
      networkToken: {Adyen.Checkout.V72.CheckoutNetworkTokenOption, :t},
