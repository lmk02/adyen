defmodule Adyen.Checkout.V65.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: Adyen.Checkout.V65.Recurring.t() | nil,
          ...
          threeDS2RequestData: Adyen.Checkout.V65.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {Adyen.Checkout.V65.Recurring, :t},
      ...
      threeDS2RequestData: {Adyen.Checkout.V65.ThreeDs2RequestData, :t},
