defmodule Adyen.Checkout.V70.BalanceCheckResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          balance: Adyen.Checkout.V70.Amount.t(),
          fraudResult: Adyen.Checkout.V70.FraudResult.t() | nil,
          pspReference: String.t() | nil,
          refusalReason: String.t() | nil,
          resultCode: String.t(),
          transactionLimit: Adyen.Checkout.V70.Amount.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      transactionLimit: {Adyen.Checkout.V70.Amount, :t}
    ]
  end
end
