defmodule Adyen.Checkout.V70.CarRental do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          noShow: boolean | nil,
          pickupInfo: Adyen.Checkout.V70.PickupInfo.t() | nil,
          ...
          rentalSurcharges: Adyen.Checkout.V70.RentalSurcharges.t() | nil,
          renterName: String.t(),
          returnInfo: Adyen.Checkout.V70.ReturnInfo.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      noShow: :boolean,
      pickupInfo: {Adyen.Checkout.V70.PickupInfo, :t},
      ...
      rentalSurcharges: {Adyen.Checkout.V70.RentalSurcharges, :t},
      renterName: :string,
      returnInfo: {Adyen.Checkout.V70.ReturnInfo, :t},
      taxExempt: :boolean
    ]
  end
end
