defmodule Adyen.Checkout.V70.Lodging do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          folio: Adyen.Checkout.V70.Folio.t() | nil,
          ...
          rooms: [Adyen.Checkout.V70.Room.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      folio: {Adyen.Checkout.V70.Folio, :t},
      ...
      renterName: :string,
      rooms: [{Adyen.Checkout.V70.Room, :t}],
