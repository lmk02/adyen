defmodule Adyen.Checkout.V66.FundRecipient do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: Adyen.Checkout.V66.CardDetails.t() | nil,
          shopperEmail: String.t() | nil,
          shopperName: Adyen.Checkout.V66.Name.t() | nil,
          shopperReference: String.t() | nil,
          storedPaymentMethodId: String.t() | nil,
          subMerchant: Adyen.Checkout.V66.SubMerchant.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: {Adyen.Checkout.V66.CardDetails, :t},
      shopperEmail: :string,
      shopperName: {Adyen.Checkout.V66.Name, :t},
      shopperReference: :string,
      storedPaymentMethodId: :string,
      subMerchant: {Adyen.Checkout.V66.SubMerchant, :t},
