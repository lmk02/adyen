defmodule Adyen.Checkout.V66.CheckoutVoucherAction do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          initialAmount: Adyen.Checkout.V66.Amount.t() | nil,
          ...
          surcharge: Adyen.Checkout.V66.Amount.t() | nil,
          totalAmount: Adyen.Checkout.V66.Amount.t() | nil,
          type: String.t(),
          url: String.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      entity: :string,
      expiresAt: :string,
      initialAmount: {Adyen.Checkout.V66.Amount, :t},
      ...
      shopperEmail: :string,
      shopperName: :string,
      surcharge: {Adyen.Checkout.V66.Amount, :t},
      totalAmount: {Adyen.Checkout.V66.Amount, :t},
      type: {:const, "voucher"},
      url: :string
    ]
  end
