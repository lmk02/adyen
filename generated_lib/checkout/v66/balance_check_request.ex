defmodule Adyen.Checkout.V66.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: Adyen.Checkout.V66.Recurring.t() | nil,
          ...
          threeDS2RequestData: Adyen.Checkout.V66.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {Adyen.Checkout.V66.Recurring, :t},
      ...
      threeDS2RequestData: {Adyen.Checkout.V66.ThreeDs2RequestData, :t},
