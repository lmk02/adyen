defmodule Adyen.Checkout.V66.BalanceCheckResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          balance: Adyen.Checkout.V66.Amount.t(),
          fraudResult: Adyen.Checkout.V66.FraudResult.t() | nil,
          pspReference: String.t() | nil,
          refusalReason: String.t() | nil,
          resultCode: String.t(),
          transactionLimit: Adyen.Checkout.V66.Amount.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      transactionLimit: {Adyen.Checkout.V66.Amount, :t}
    ]
  end
end
