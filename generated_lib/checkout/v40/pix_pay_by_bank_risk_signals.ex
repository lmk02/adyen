defmodule Adyen.Checkout.V40.PixPayByBankRiskSignals do
  @moduledoc """
  Provides struct and type for a PixPayByBankRiskSignals
  """

  @type t :: %__MODULE__{
          confidenceScore: Adyen.Checkout.V40.ConfidenceScore.t() | nil,
          elapsedTimeSinceBoot: integer | nil,
          isRootedDevice: boolean | nil,
          language: String.t() | nil,
          osVersion: String.t() | nil,
          screenBrightness: integer | nil,
          screenDimensions: Adyen.Checkout.V40.ScreenDimensions.t() | nil,
  ...
  def __fields__(:t) do
    [
      confidenceScore: {Adyen.Checkout.V40.ConfidenceScore, :t},
      elapsedTimeSinceBoot: {:integer, "int64"},
      isRootedDevice: :boolean,
      language: :string,
      osVersion: :string,
      screenBrightness: {:integer, "int32"},
      screenDimensions: {Adyen.Checkout.V40.ScreenDimensions, :t},
