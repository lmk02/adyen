defmodule Adyen.Checkout.V69.Utility do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec post_apple_pay_sessions(
          body :: Adyen.Checkout.V69.ApplePaySessionRequest.t(),
          opts :: keyword
        ) :: {:ok, Adyen.Checkout.V69.ApplePaySessionResponse.t()} | :error
  def post_apple_pay_sessions(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V69.Utility, :post_apple_pay_sessions},
      url: "/applePay/sessions",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V69.ApplePaySessionRequest, :t}}],
      response: [{200, {Adyen.Checkout.V69.ApplePaySessionResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  """
  @spec post_origin_keys(body :: Adyen.Checkout.V69.UtilityRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V69.UtilityResponse.t()}
  ...
  def post_origin_keys(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V69.Utility, :post_origin_keys},
      url: "/originKeys",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V69.UtilityRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V69.UtilityResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_paypal_update_order(
          body :: Adyen.Checkout.V69.PaypalUpdateOrderRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V69.PaypalUpdateOrderResponse.t()}
          | {:error, Adyen.Checkout.V69.ServiceError.t()}
  def post_paypal_update_order(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V69.Utility, :post_paypal_update_order},
      url: "/paypal/updateOrder",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V69.PaypalUpdateOrderRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V69.PaypalUpdateOrderResponse, :t}},
        {400, {Adyen.Checkout.V69.ServiceError, :t}},
        {401, {Adyen.Checkout.V69.ServiceError, :t}},
        {403, {Adyen.Checkout.V69.ServiceError, :t}},
        {422, {Adyen.Checkout.V69.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_validate_shopper_id(
          body :: Adyen.Checkout.V69.ValidateShopperIdRequest.t(),
          opts :: keyword
        ) ::
  ...
  def post_validate_shopper_id(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V69.Utility, :post_validate_shopper_id},
