defmodule Adyen.Checkout.V69.BalanceCheckResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          balance: Adyen.Checkout.V69.Amount.t(),
          fraudResult: Adyen.Checkout.V69.FraudResult.t() | nil,
          pspReference: String.t() | nil,
          refusalReason: String.t() | nil,
          resultCode: String.t(),
          transactionLimit: Adyen.Checkout.V69.Amount.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      transactionLimit: {Adyen.Checkout.V69.Amount, :t}
    ]
  end
end
