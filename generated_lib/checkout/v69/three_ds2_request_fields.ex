defmodule Adyen.Checkout.V69.ThreeDs2RequestFields do
  @moduledoc """
  Provides struct and type for a ThreeDs2RequestFields
  """

  @type t :: %__MODULE__{
          acctInfo: Adyen.Checkout.V69.AcctInfo.t() | nil,
          ...
          deviceRenderOptions: Adyen.Checkout.V69.DeviceRenderOptions.t() | nil,
          homePhone: Adyen.Checkout.V69.Phone.t() | nil,
          mcc: String.t() | nil,
          merchantName: String.t() | nil,
          messageVersion: String.t() | nil,
          mobilePhone: Adyen.Checkout.V69.Phone.t() | nil,
          ...
          sdkEphemPubKey: Adyen.Checkout.V69.SDKEphemPubKey.t() | nil,
  ...
  def __fields__(:t) do
    [
      acctInfo: {Adyen.Checkout.V69.AcctInfo, :t},
      ...
      deviceRenderOptions: {Adyen.Checkout.V69.DeviceRenderOptions, :t},
      homePhone: {Adyen.Checkout.V69.Phone, :t},
      mcc: :string,
      merchantName: :string,
      messageVersion: :string,
      mobilePhone: {Adyen.Checkout.V69.Phone, :t},
      ...
      sdkAppID: :string,
      sdkEphemPubKey: {Adyen.Checkout.V69.SDKEphemPubKey, :t},
      ...
      threeDSRequestorAuthenticationInfo:
        {Adyen.Checkout.V69.ThreeDSRequestorAuthenticationInfo, :t},
      threeDSRequestorChallengeInd: {:enum, ["01", "02", "03", "04", "05", "06"]},
      threeDSRequestorID: :string,
      threeDSRequestorName: :string,
      threeDSRequestorPriorAuthenticationInfo:
        {Adyen.Checkout.V69.ThreeDSRequestorPriorAuthenticationInfo, :t},
      ...
      workPhone: {Adyen.Checkout.V69.Phone, :t}
    ]
  end
end
