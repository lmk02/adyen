defmodule Adyen.Checkout.V69.PaymentDetailsResponse do
  @moduledoc """
  Provides struct and type for a PaymentDetailsResponse
  """

  @type t :: %__MODULE__{
          action: Adyen.Checkout.V69.CheckoutThreeDs2Action.t() | nil,
  ...
  def __fields__(:t) do
    [
      action: {Adyen.Checkout.V69.CheckoutThreeDs2Action, :t},
      additionalData: :map,
