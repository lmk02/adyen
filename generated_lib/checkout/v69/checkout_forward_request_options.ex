defmodule Adyen.Checkout.V69.CheckoutForwardRequestOptions do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          dryRun: boolean | nil,
          networkToken: Adyen.Checkout.V69.CheckoutNetworkTokenOption.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      dryRun: :boolean,
      networkToken: {Adyen.Checkout.V69.CheckoutNetworkTokenOption, :t},
