defmodule Adyen.Checkout.V41.Recurring do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_forward(body :: Adyen.Checkout.V41.CheckoutForwardRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V41.CheckoutForwardResponse.t()} | :error
  def post_forward(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V41.Recurring, :post_forward},
      url: "/forward",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V41.CheckoutForwardRequest, :t}}],
      response: [{200, {Adyen.Checkout.V41.CheckoutForwardResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  @spec post_stored_payment_methods(
          body :: Adyen.Checkout.V41.StoredPaymentMethodRequest.t(),
          opts :: keyword
        ) :: {:ok, Adyen.Checkout.V41.StoredPaymentMethodResource.t()} | :error
  def post_stored_payment_methods(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V41.Recurring, :post_stored_payment_methods},
      url: "/storedPaymentMethods",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V41.StoredPaymentMethodRequest, :t}}],
      response: [{201, {Adyen.Checkout.V41.StoredPaymentMethodResource, :t}}],
      opts: opts
    })
  end
