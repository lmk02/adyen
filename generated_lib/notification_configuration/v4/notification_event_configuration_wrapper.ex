defmodule Adyen.NotificationConfiguration.V4.NotificationEventConfigurationWrapper do
  @moduledoc """
  ...
  def __fields__(:t) do
    [
      NotificationEventConfiguration:
        {Adyen.NotificationConfiguration.V4.NotificationEventConfiguration, :t}
    ]
  end
end
