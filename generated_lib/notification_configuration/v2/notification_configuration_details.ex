defmodule Adyen.NotificationConfiguration.V2.NotificationConfigurationDetails do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          eventConfigs:
            [Adyen.NotificationConfiguration.V2.NotificationEventConfigurationWrapper.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      description: :string,
      eventConfigs: [
        {Adyen.NotificationConfiguration.V2.NotificationEventConfigurationWrapper, :t}
      ],
