defmodule Adyen.NotificationConfiguration.V2.NotificationConfigurationDetailsWrapper do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          NotificationConfigurationDetails:
            Adyen.NotificationConfiguration.V2.NotificationConfigurationDetails.t() | nil
        }
