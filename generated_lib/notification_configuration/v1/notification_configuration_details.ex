defmodule Adyen.NotificationConfiguration.V1.NotificationConfigurationDetails do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          eventConfigs:
            [Adyen.NotificationConfiguration.V1.NotificationEventConfigurationWrapper.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      description: :string,
      eventConfigs: [
        {Adyen.NotificationConfiguration.V1.NotificationEventConfigurationWrapper, :t}
      ],
