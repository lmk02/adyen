defmodule Adyen.NotificationConfiguration.V1.NotificationConfigurationDetailsWrapper do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          NotificationConfigurationDetails:
            Adyen.NotificationConfiguration.V1.NotificationConfigurationDetails.t() | nil
        }
