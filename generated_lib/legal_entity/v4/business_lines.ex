defmodule Adyen.LegalEntity.V4.BusinessLines do
  @moduledoc """
  ...
  def delete_business_lines_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.V4.BusinessLines, :delete_business_lines_id},
  ...
  @spec get_business_lines_id(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.V4.BusinessLine.t()}
  ...
  def get_business_lines_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.V4.BusinessLines, :get_business_lines_id},
      url: "/businessLines/#{id}",
      method: :get,
      response: [
        {200, {Adyen.LegalEntity.V4.BusinessLine, :t}},
        {400, {Adyen.LegalEntity.V4.ServiceError, :t}},
        {401, {Adyen.LegalEntity.V4.ServiceError, :t}},
        {403, {Adyen.LegalEntity.V4.ServiceError, :t}},
        {422, {Adyen.LegalEntity.V4.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_business_lines_id(
          id :: String.t(),
          body :: Adyen.LegalEntity.V4.BusinessLineInfoUpdate.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.LegalEntity.V4.BusinessLine.t()}
          | {:error, Adyen.LegalEntity.V4.ServiceError.t()}
  def patch_business_lines_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.LegalEntity.V4.BusinessLines, :patch_business_lines_id},
      url: "/businessLines/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.LegalEntity.V4.BusinessLineInfoUpdate, :t}}],
      response: [
        {200, {Adyen.LegalEntity.V4.BusinessLine, :t}},
        {400, {Adyen.LegalEntity.V4.ServiceError, :t}},
        {401, {Adyen.LegalEntity.V4.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_business_lines(body :: Adyen.LegalEntity.V4.BusinessLineInfo.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.V4.BusinessLine.t()}
          | {:error, Adyen.LegalEntity.V4.ServiceError.t()}
  def post_business_lines(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.LegalEntity.V4.BusinessLines, :post_business_lines},
      url: "/businessLines",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.LegalEntity.V4.BusinessLineInfo, :t}}],
      response: [
        {200, {Adyen.LegalEntity.V4.BusinessLine, :t}},
        {400, {Adyen.LegalEntity.V4.ServiceError, :t}},
        {401, {Adyen.LegalEntity.V4.ServiceError, :t}},
  ...
  @type t :: %__MODULE__{businessLines: [Adyen.LegalEntity.V4.BusinessLine.t()]}
  ...
  def __fields__(:t) do
    [businessLines: [{Adyen.LegalEntity.V4.BusinessLine, :t}]]
  end
end
