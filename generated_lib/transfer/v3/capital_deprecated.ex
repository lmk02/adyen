defmodule Adyen.Transfer.V3.CapitalDeprecated do
  @moduledoc """
  ...
  def get_grants(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.Transfer.V3.CapitalDeprecated, :get_grants},
      url: "/grants",
      method: :get,
      query: query,
      response: [
  ...
  def get_grants_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.Transfer.V3.CapitalDeprecated, :get_grants_id},
      url: "/grants/#{id}",
      method: :get,
      response: [
  ...
  **Content Types**: `application/json`
  ...
  def post_grants(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Transfer.V3.CapitalDeprecated, :post_grants},
      url: "/grants",
      body: body,
      method: :post,
