defmodule Adyen.Account.V6.GetUploadedDocumentsResponse do
  @moduledoc """
  Provides struct and type for a GetUploadedDocumentsResponse
  """

  @type t :: %__MODULE__{
          documentDetails: [Adyen.Account.V6.DocumentDetail.t()] | nil,
  ...
  def __fields__(:t) do
    [
      documentDetails: [{Adyen.Account.V6.DocumentDetail, :t}],
