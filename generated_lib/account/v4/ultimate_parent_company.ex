defmodule Adyen.Account.V4.UltimateParentCompany do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          businessDetails: Adyen.Account.V4.UltimateParentCompanyBusinessDetails.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      businessDetails: {Adyen.Account.V4.UltimateParentCompanyBusinessDetails, :t},
