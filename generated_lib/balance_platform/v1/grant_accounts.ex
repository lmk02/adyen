defmodule Adyen.BalancePlatform.V1.GrantAccounts do
  @moduledoc """
  ...
  @spec get_grant_accounts_id(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.BalancePlatform.V1.CapitalGrantAccount.t()}
  ...
  def get_grant_accounts_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.BalancePlatform.V1.GrantAccounts, :get_grant_accounts_id},
      url: "/grantAccounts/#{id}",
      method: :get,
      response: [
        {200, {Adyen.BalancePlatform.V1.CapitalGrantAccount, :t}},
