defmodule Adyen.BalancePlatform.V1.TransferRoutes do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec post_transfer_routes_calculate(
          body :: Adyen.BalancePlatform.V1.TransferRouteRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.BalancePlatform.V1.TransferRouteResponse.t()}
  ...
  def post_transfer_routes_calculate(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.BalancePlatform.V1.TransferRoutes, :post_transfer_routes_calculate},
      url: "/transferRoutes/calculate",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.BalancePlatform.V1.TransferRouteRequest, :t}}],
      response: [
        {200, {Adyen.BalancePlatform.V1.TransferRouteResponse, :t}},
