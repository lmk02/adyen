defmodule Adyen.BalancePlatform.V1.NetworkTokens do
  @moduledoc """
  ...
  @spec get_network_tokens_network_token_id(networkTokenId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.BalancePlatform.V1.GetNetworkTokenResponse.t()}
  ...
  def get_network_tokens_network_token_id(networkTokenId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.BalancePlatform.V1.NetworkTokens, :get_network_tokens_network_token_id},
      url: "/networkTokens/#{networkTokenId}",
      method: :get,
      response: [
        {200, {Adyen.BalancePlatform.V1.GetNetworkTokenResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_network_tokens_network_token_id(
          ...
          body :: Adyen.BalancePlatform.V1.UpdateNetworkTokenRequest.t(),
          opts :: keyword
  ...
  def patch_network_tokens_network_token_id(networkTokenId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.BalancePlatform.V1.NetworkTokens, :patch_network_tokens_network_token_id},
      url: "/networkTokens/#{networkTokenId}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.BalancePlatform.V1.UpdateNetworkTokenRequest, :t}}],
      response: [
        {202, :null},
        {401, {Adyen.BalancePlatform.V1.RestServiceError, :t}},
        {403, {Adyen.BalancePlatform.V1.RestServiceError, :t}},
