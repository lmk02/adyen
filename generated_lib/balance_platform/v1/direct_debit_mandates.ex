defmodule Adyen.BalancePlatform.V1.DirectDebitMandates do
  @moduledoc """
  ...
  @spec get_mandates(opts :: keyword) ::
          {:ok, Adyen.BalancePlatform.V1.ListMandatesResponse.t()}
          | {:error, Adyen.BalancePlatform.V1.DefaultErrorResponseEntity.t()}
  def get_mandates(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.BalancePlatform.V1.DirectDebitMandates, :get_mandates},
      url: "/mandates",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.BalancePlatform.V1.ListMandatesResponse, :t}},
        {401, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {422, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {500, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}}
      ],
      opts: opts
    })
  end
  ...
  @spec get_mandates_mandate_id(mandateId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.BalancePlatform.V1.Mandate.t()}
          | {:error, Adyen.BalancePlatform.V1.DefaultErrorResponseEntity.t()}
  def get_mandates_mandate_id(mandateId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.BalancePlatform.V1.DirectDebitMandates, :get_mandates_mandate_id},
      url: "/mandates/#{mandateId}",
      method: :get,
      response: [
        {200, {Adyen.BalancePlatform.V1.Mandate, :t}},
        {401, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {404, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {422, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {500, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}}
      ],
      opts: opts
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_mandates_mandate_id(
          mandateId :: String.t(),
          body :: Adyen.BalancePlatform.V1.MandateUpdate.t(),
          opts :: keyword
        ) :: :ok | {:error, Adyen.BalancePlatform.V1.DefaultErrorResponseEntity.t()}
  def patch_mandates_mandate_id(mandateId, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [mandateId: mandateId, body: body],
      call: {Adyen.BalancePlatform.V1.DirectDebitMandates, :patch_mandates_mandate_id},
      url: "/mandates/#{mandateId}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.BalancePlatform.V1.MandateUpdate, :t}}],
      response: [
        {202, :null},
        {401, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
  ...
  def post_mandates_mandate_id_cancel(mandateId, opts \\ []) do
    ...
    client.request(%{
      args: [mandateId: mandateId],
      call: {Adyen.BalancePlatform.V1.DirectDebitMandates, :post_mandates_mandate_id_cancel},
