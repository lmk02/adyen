defmodule Adyen.BalancePlatform.V1.TransferRouteRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          category: String.t(),
          counterparty: Adyen.BalancePlatform.V1.Counterparty.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      category: {:const, "bank"},
      counterparty: {Adyen.BalancePlatform.V1.Counterparty, :t},
      country: :string,
      currency: :string,
