defmodule Adyen.BalancePlatform.V1.ManageCardPIN do
  @moduledoc """
  ...
  @spec get_public_key(opts :: keyword) ::
          {:ok, Adyen.BalancePlatform.V1.PublicKeyResponse.t()}
  ...
  def get_public_key(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.BalancePlatform.V1.ManageCardPIN, :get_public_key},
      url: "/publicKey",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.BalancePlatform.V1.PublicKeyResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_pins_change(body :: Adyen.BalancePlatform.V1.PinChangeRequest.t(), opts :: keyword) ::
          {:ok, Adyen.BalancePlatform.V1.PinChangeResponse.t()}
          | {:error, Adyen.BalancePlatform.V1.RestServiceError.t()}
  def post_pins_change(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.BalancePlatform.V1.ManageCardPIN, :post_pins_change},
      url: "/pins/change",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.BalancePlatform.V1.PinChangeRequest, :t}}],
      response: [
        {200, {Adyen.BalancePlatform.V1.PinChangeResponse, :t}},
        {401, {Adyen.BalancePlatform.V1.RestServiceError, :t}},
        {403, {Adyen.BalancePlatform.V1.RestServiceError, :t}},
        {422, {Adyen.BalancePlatform.V1.RestServiceError, :t}},
        {500, {Adyen.BalancePlatform.V1.RestServiceError, :t}}
  ...
  **Content Types**: `application/json`
  """
  @spec post_pins_reveal(body :: Adyen.BalancePlatform.V1.RevealPinRequest.t(), opts :: keyword) ::
          {:ok, Adyen.BalancePlatform.V1.RevealPinResponse.t()}
          | {:error, Adyen.BalancePlatform.V1.RestServiceError.t()}
  def post_pins_reveal(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.BalancePlatform.V1.ManageCardPIN, :post_pins_reveal},
      url: "/pins/reveal",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.BalancePlatform.V1.RevealPinRequest, :t}}],
      response: [
        {200, {Adyen.BalancePlatform.V1.RevealPinResponse, :t}},
        {401, {Adyen.BalancePlatform.V1.RestServiceError, :t}},
        {403, {Adyen.BalancePlatform.V1.RestServiceError, :t}},
        {422, {Adyen.BalancePlatform.V1.RestServiceError, :t}},
        {500, {Adyen.BalancePlatform.V1.RestServiceError, :t}}
