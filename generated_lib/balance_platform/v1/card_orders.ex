defmodule Adyen.BalancePlatform.V1.CardOrders do
  @moduledoc """
  ...
  @spec get_cardorders(opts :: keyword) ::
          {:ok, Adyen.BalancePlatform.V1.PaginatedGetCardOrderResponse.t()}
  ...
  def get_cardorders(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.BalancePlatform.V1.CardOrders, :get_cardorders},
      url: "/cardorders",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.BalancePlatform.V1.PaginatedGetCardOrderResponse, :t}},
  ...
  @spec get_cardorders_id_items(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.BalancePlatform.V1.PaginatedGetCardOrderItemResponse.t()}
          | {:error, Adyen.BalancePlatform.V1.RestServiceError.t()}
  def get_cardorders_id_items(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.BalancePlatform.V1.CardOrders, :get_cardorders_id_items},
      url: "/cardorders/#{id}/items",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.BalancePlatform.V1.PaginatedGetCardOrderItemResponse, :t}},
        {401, {Adyen.BalancePlatform.V1.RestServiceError, :t}},
        {403, {Adyen.BalancePlatform.V1.RestServiceError, :t}},
        {422, {Adyen.BalancePlatform.V1.RestServiceError, :t}},
        {500, {Adyen.BalancePlatform.V1.RestServiceError, :t}}
