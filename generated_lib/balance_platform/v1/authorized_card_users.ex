defmodule Adyen.BalancePlatform.V1.AuthorizedCardUsers do
  @moduledoc """
  ...
  def delete_payment_instruments_payment_instrument_id_authorised_card_users(
    ...
    client.request(%{
      ...
      call:
        {Adyen.BalancePlatform.V1.AuthorizedCardUsers,
  ...
  @spec get_payment_instruments_payment_instrument_id_authorised_card_users(
          ...
          {:ok, Adyen.BalancePlatform.V1.AuthorisedCardUsers.t()}
  ...
  def get_payment_instruments_payment_instrument_id_authorised_card_users(
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {Adyen.BalancePlatform.V1.AuthorisedCardUsers, :t}},
        {401, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_payment_instruments_payment_instrument_id_authorised_card_users(
          paymentInstrumentId :: String.t(),
          body :: Adyen.BalancePlatform.V1.AuthorisedCardUsers.t(),
          opts :: keyword
        ) :: :ok | {:error, Adyen.BalancePlatform.V1.DefaultErrorResponseEntity.t()}
  def patch_payment_instruments_payment_instrument_id_authorised_card_users(
    ...
    client.request(%{
      ...
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.BalancePlatform.V1.AuthorisedCardUsers, :t}}],
      response: [
        {204, :null},
        {400, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {401, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {422, {Adyen.BalancePlatform.V1.DefaultErrorResponseEntity, :t}}
      ],
