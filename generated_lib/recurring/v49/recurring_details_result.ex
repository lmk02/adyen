defmodule Adyen.Recurring.V49.RecurringDetailsResult do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          details: [Adyen.Recurring.V49.RecurringDetailWrapper.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      details: [{Adyen.Recurring.V49.RecurringDetailWrapper, :t}],
