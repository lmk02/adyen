defmodule Adyen.Payout.V50.PayoutRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          fundSource: Adyen.Payout.V50.FundSource.t() | nil,
          merchantAccount: String.t(),
          recurring: Adyen.Payout.V50.Recurring.t() | nil,
          reference: String.t(),
  ...
  def __fields__(:t) do
    [
      ...
      fundSource: {Adyen.Payout.V50.FundSource, :t},
