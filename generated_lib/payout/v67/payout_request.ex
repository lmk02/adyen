defmodule Adyen.Payout.V67.PayoutRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          fundSource: Adyen.Payout.V67.FundSource.t() | nil,
          merchantAccount: String.t(),
          recurring: Adyen.Payout.V67.Recurring.t() | nil,
          reference: String.t(),
  ...
  def __fields__(:t) do
    [
      ...
      fundSource: {Adyen.Payout.V67.FundSource, :t},
