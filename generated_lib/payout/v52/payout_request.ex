defmodule Adyen.Payout.V52.PayoutRequest do
  @moduledoc """
  Provides struct and type for a PayoutRequest
  """

  @type t :: %__MODULE__{
          amount: Adyen.Payout.V52.Amount.t(),
          billingAddress: Adyen.Payout.V52.Address.t() | nil,
          card: Adyen.Payout.V52.Card.t() | nil,
          fraudOffset: integer | nil,
          fundSource: Adyen.Payout.V52.FundSource.t() | nil,
          merchantAccount: String.t(),
          recurring: Adyen.Payout.V52.Recurring.t() | nil,
          reference: String.t(),
  ...
  def __fields__(:t) do
    [
      ...
      fundSource: {Adyen.Payout.V52.FundSource, :t},
      merchantAccount: :string,
      recurring: {Adyen.Payout.V52.Recurring, :t},
      reference: :string,
