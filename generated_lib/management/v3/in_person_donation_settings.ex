defmodule Adyen.Management.V3.InPersonDonationSettings do
  @moduledoc """
  Provides struct and type for a InPersonDonationSettings
  """

  @type t :: %__MODULE__{
          defaultAmount: Adyen.Management.V3.DonationAmount.t() | nil,
  ...
  def __fields__(:t) do
    [
      defaultAmount: {Adyen.Management.V3.DonationAmount, :t},
