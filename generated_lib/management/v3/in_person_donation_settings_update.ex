defmodule Adyen.Management.V3.InPersonDonationSettingsUpdate do
  @moduledoc """
  Provides struct and type for a InPersonDonationSettingsUpdate
  """

  @type t :: %__MODULE__{
          defaultAmount: Adyen.Management.V3.DonationAmountUpdate.t() | nil,
  ...
  def __fields__(:t) do
    [
      defaultAmount: {:union, [{Adyen.Management.V3.DonationAmountUpdate, :t}, :null]},
