defmodule Adyen.Management.V3.Connectivity do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          terminalIPAddressURL: Adyen.Management.V3.EventUrl.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      terminalIPAddressURL: {Adyen.Management.V3.EventUrl, :t}
    ]
  end
end
