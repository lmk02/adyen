defmodule Adyen.Payment.V52.ThreeDs2RequestData do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          deviceRenderOptions: Adyen.Payment.V52.DeviceRenderOptions.t() | nil,
          mcc: String.t() | nil,
          ...
          sdkEphemPubKey: Adyen.Payment.V52.SDKEphemPubKey.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      deviceRenderOptions: {Adyen.Payment.V52.DeviceRenderOptions, :t},
      mcc: :string,
      merchantName: :string,
      ...
      sdkAppID: :string,
      sdkEncData: :string,
      sdkEphemPubKey: {Adyen.Payment.V52.SDKEphemPubKey, :t},
