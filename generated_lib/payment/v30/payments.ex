defmodule Adyen.Payment.V30.Payments do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_authorise(body :: Adyen.Payment.V30.PaymentRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Payment.V30.PaymentResult.t()}
  ...
  def post_authorise(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Payment.V30.Payments, :post_authorise},
      url: "/authorise",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payment.V30.PaymentRequest, :t}}],
      response: [
        {200, {Adyen.Payment.V30.PaymentResult, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_authorise3_d(body :: Adyen.Payment.V30.PaymentRequest3D.t(), opts :: keyword) ::
          {:ok, Adyen.Payment.V30.PaymentResult.t()}
          | {:error, Adyen.Payment.V30.ServiceError.t()}
  def post_authorise3_d(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Payment.V30.Payments, :post_authorise3_d},
      url: "/authorise3d",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payment.V30.PaymentRequest3D, :t}}],
      response: [
        {200, {Adyen.Payment.V30.PaymentResult, :t}},
        {400, {Adyen.Payment.V30.ServiceError, :t}},
        {401, {Adyen.Payment.V30.ServiceError, :t}},
