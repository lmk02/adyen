defmodule Adyen.Payment.V30.Modifications do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec post_adjust_authorisation(
          body :: Adyen.Payment.V30.AdjustAuthorisationRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Payment.V30.ModificationResult.t()}
          | {:error, Adyen.Payment.V30.ServiceError.t()}
  def post_adjust_authorisation(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Payment.V30.Modifications, :post_adjust_authorisation},
      url: "/adjustAuthorisation",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payment.V30.AdjustAuthorisationRequest, :t}}],
      response: [
        {200, {Adyen.Payment.V30.ModificationResult, :t}},
        {400, {Adyen.Payment.V30.ServiceError, :t}},
        {401, {Adyen.Payment.V30.ServiceError, :t}},
        {403, {Adyen.Payment.V30.ServiceError, :t}},
        {422, {Adyen.Payment.V30.ServiceError, :t}},
        {500, {Adyen.Payment.V30.ServiceError, :t}}
      ],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  """
  @spec post_cancel(body :: Adyen.Payment.V30.CancelRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Payment.V30.ModificationResult.t()}
          | {:error, Adyen.Payment.V30.ServiceError.t()}
  def post_cancel(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Payment.V30.Modifications, :post_cancel},
      url: "/cancel",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payment.V30.CancelRequest, :t}}],
      response: [
        {200, {Adyen.Payment.V30.ModificationResult, :t}},
        {400, {Adyen.Payment.V30.ServiceError, :t}},
        {401, {Adyen.Payment.V30.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_cancel_or_refund(
          body :: Adyen.Payment.V30.CancelOrRefundRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Payment.V30.ModificationResult.t()}
          | {:error, Adyen.Payment.V30.ServiceError.t()}
  def post_cancel_or_refund(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Payment.V30.Modifications, :post_cancel_or_refund},
      url: "/cancelOrRefund",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payment.V30.CancelOrRefundRequest, :t}}],
      response: [
        {200, {Adyen.Payment.V30.ModificationResult, :t}},
        {400, {Adyen.Payment.V30.ServiceError, :t}},
        {401, {Adyen.Payment.V30.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_capture(body :: Adyen.Payment.V30.CaptureRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Payment.V30.ModificationResult.t()}
          | {:error, Adyen.Payment.V30.ServiceError.t()}
  def post_capture(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Payment.V30.Modifications, :post_capture},
      url: "/capture",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payment.V30.CaptureRequest, :t}}],
      response: [
        {200, {Adyen.Payment.V30.ModificationResult, :t}},
        {400, {Adyen.Payment.V30.ServiceError, :t}},
        {401, {Adyen.Payment.V30.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_refund(body :: Adyen.Payment.V30.RefundRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Payment.V30.ModificationResult.t()}
          | {:error, Adyen.Payment.V30.ServiceError.t()}
  def post_refund(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Payment.V30.Modifications, :post_refund},
      url: "/refund",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payment.V30.RefundRequest, :t}}],
      response: [
        {200, {Adyen.Payment.V30.ModificationResult, :t}},
        {400, {Adyen.Payment.V30.ServiceError, :t}},
        {401, {Adyen.Payment.V30.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_technical_cancel(
          body :: Adyen.Payment.V30.TechnicalCancelRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Payment.V30.ModificationResult.t()}
          | {:error, Adyen.Payment.V30.ServiceError.t()}
  def post_technical_cancel(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Payment.V30.Modifications, :post_technical_cancel},
      url: "/technicalCancel",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payment.V30.TechnicalCancelRequest, :t}}],
      response: [
        {200, {Adyen.Payment.V30.ModificationResult, :t}},
        {400, {Adyen.Payment.V30.ServiceError, :t}},
        {401, {Adyen.Payment.V30.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_void_pending_refund(
          body :: Adyen.Payment.V30.VoidPendingRefundRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Payment.V30.ModificationResult.t()}
          | {:error, Adyen.Payment.V30.ServiceError.t()}
  def post_void_pending_refund(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Payment.V30.Modifications, :post_void_pending_refund},
      url: "/voidPendingRefund",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payment.V30.VoidPendingRefundRequest, :t}}],
      response: [
        {200, {Adyen.Payment.V30.ModificationResult, :t}},
        {400, {Adyen.Payment.V30.ServiceError, :t}},
        {401, {Adyen.Payment.V30.ServiceError, :t}},
