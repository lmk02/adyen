defmodule Adyen.Checkout.Payments do
  ...
  def get_sessions_session_id(sessionId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Checkout.Payments, :get_sessions_session_id},
  ...
  **Content Types**: `application/json`
  """
  @spec post_card_details(body :: Adyen.Checkout.CardDetailsRequest.t(), opts :: keyword) ::
  ...
  def post_card_details(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.Payments, :post_card_details},
      url: "/cardDetails",
      body: body,
      method: :post,
  ...
  **Content Types**: `application/json`
  """
  @spec post_payment_methods(body :: Adyen.Checkout.PaymentMethodsRequest.t(), opts :: keyword) ::
  ...
  def post_payment_methods(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.Payments, :post_payment_methods},
      url: "/paymentMethods",
      body: body,
      method: :post,
  ...
  **Content Types**: `application/json`
  """
  @spec post_payments(body :: Adyen.Checkout.PaymentRequest.t(), opts :: keyword) ::
  ...
  def post_payments(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.Payments, :post_payments},
      url: "/payments",
      body: body,
      method: :post,
  ...
  **Content Types**: `application/json`
  """
  @spec post_payments_details(body :: Adyen.Checkout.PaymentDetailsRequest.t(), opts :: keyword) ::
  ...
  def post_payments_details(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.Payments, :post_payments_details},
  ...
  **Content Types**: `application/json`
  """
  @spec post_sessions(body :: Adyen.Checkout.CreateCheckoutSessionRequest.t(), opts :: keyword) ::
  ...
  def post_sessions(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.Payments, :post_sessions},
      url: "/sessions",
      body: body,
      method: :post,
