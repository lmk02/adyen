defmodule Adyen.Checkout.Recurring do
  @moduledoc """
  ...
  def delete_stored_payment_methods_stored_payment_method(storedPaymentMethodId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Checkout.Recurring, :delete_stored_payment_methods_stored_payment_method},
  ...
  **Content Types**: `application/json`
  """
  @spec create_forward(body :: Adyen.Checkout.ForwardRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.ForwardResponse.t()} | :error
  def create_forward(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.Recurring, :create_forward},
      url: "/forward",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.ForwardRequest, :t}}],
      response: [{200, {Adyen.Checkout.ForwardResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  def create_stored_payment_methods(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.Recurring, :create_stored_payment_methods},
      url: "/storedPaymentMethods",
      body: body,
      method: :post,
