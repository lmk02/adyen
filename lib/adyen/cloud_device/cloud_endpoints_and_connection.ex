defmodule Adyen.CloudDevice.CloudEndpointsAndConnection do
  @moduledoc """
  ...
  * **Cloud Device API role**
  ...
  @spec get_merchants_merchant_account_connected_devices(
          ...
          {:ok, Adyen.CloudDevice.ConnectedDevicesResponse.t()}
          | {:error, Adyen.CloudDevice.DefaultErrorResponseEntity.t()}
  def get_merchants_merchant_account_connected_devices(merchantAccount, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.CloudDevice.CloudEndpointsAndConnection,
         :get_merchants_merchant_account_connected_devices},
      url: "/merchants/#{merchantAccount}/connectedDevices",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.CloudDevice.ConnectedDevicesResponse, :t}},
        {401, {Adyen.CloudDevice.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.CloudDevice.DefaultErrorResponseEntity, :t}}
      ],
      opts: opts
    })
  end
  ...
  * **Cloud Device API role**
  ...
  @spec get_merchants_merchant_account_devices_device_id_status(
          ...
          {:ok, Adyen.CloudDevice.DeviceStatusResponse.t()}
          | {:error, Adyen.CloudDevice.DefaultErrorResponseEntity.t()}
  def get_merchants_merchant_account_devices_device_id_status(
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {Adyen.CloudDevice.DeviceStatusResponse, :t}},
        {401, {Adyen.CloudDevice.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.CloudDevice.DefaultErrorResponseEntity, :t}}
      ],
      opts: opts
