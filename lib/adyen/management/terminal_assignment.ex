defmodule Adyen.Management.TerminalAssignment do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          reassignmentTarget: Adyen.Management.TerminalReassignmentTarget.t() | nil,
          status: String.t(),
  ...
  def __fields__(:t) do
    [
      companyId: :string,
      merchantId: :string,
      reassignmentTarget: {Adyen.Management.TerminalReassignmentTarget, :t},
