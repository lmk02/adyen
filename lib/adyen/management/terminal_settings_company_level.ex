defmodule Adyen.Management.TerminalSettingsCompanyLevel do
  @moduledoc """
  ...
  * Management API—Terminal settings read and write
  ...
  def get_companies_company_id_terminal_logos(companyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.TerminalSettingsCompanyLevel, :get_companies_company_id_terminal_logos},
  ...
  * Management API—Terminal settings Advanced read and write
  ...
  def get_companies_company_id_terminal_settings(companyId, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId],
      call:
        {Adyen.Management.TerminalSettingsCompanyLevel,
