defmodule Adyen.Management.TerminalActionsCompanyLevel do
  @moduledoc """
  ...
  * Management API—Terminal actions read and write
  ...
  @spec get_companies_company_id_terminal_actions(companyId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Management.ListExternalTerminalActionsResponse.t()}
  ...
  def get_companies_company_id_terminal_actions(companyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.TerminalActionsCompanyLevel, :get_companies_company_id_terminal_actions},
      url: "/companies/#{companyId}/terminalActions",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.Management.ListExternalTerminalActionsResponse, :t}},
  ...
  * Management API—Terminal actions read and write
  ...
  @spec get_companies_company_id_terminal_actions_action_id(
          ...
          {:ok, Adyen.Management.ExternalTerminalAction.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
