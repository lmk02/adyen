defmodule Adyen.Management.WebhooksMerchantLevel do
  @moduledoc """
  ...
  * Management API—Webhooks read and write
  ...
  def delete_merchants_merchant_id_webhooks_webhook_id(merchantId, webhookId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.WebhooksMerchantLevel,
  ...
  * Management API—Webhooks read and write
  ...
  def get_merchants_merchant_id_webhooks(merchantId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Management.WebhooksMerchantLevel, :get_merchants_merchant_id_webhooks},
  ...
  * Management API—Webhooks read and write
  ...
  def get_merchants_merchant_id_webhooks_webhook_id(merchantId, webhookId, opts \\ []) do
    ...
    client.request(%{
      args: [merchantId: merchantId, webhookId: webhookId],
      call:
        {Adyen.Management.WebhooksMerchantLevel, :get_merchants_merchant_id_webhooks_webhook_id},
      url: "/merchants/#{merchantId}/webhooks/#{webhookId}",
      method: :get,
      response: [
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_merchants_merchant_id_webhooks_webhook_id(
          merchantId :: String.t(),
          webhookId :: String.t(),
          body :: Adyen.Management.UpdateMerchantWebhookRequest.t(),
          opts :: keyword
        ) :: {:ok, Adyen.Management.Webhook.t()} | {:error, Adyen.Management.RestServiceError.t()}
  def patch_merchants_merchant_id_webhooks_webhook_id(merchantId, webhookId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.WebhooksMerchantLevel, :patch_merchants_merchant_id_webhooks_webhook_id},
      url: "/merchants/#{merchantId}/webhooks/#{webhookId}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.Management.UpdateMerchantWebhookRequest, :t}}],
      response: [
        {200, {Adyen.Management.Webhook, :t}},
        {204, :null},
        {400, {Adyen.Management.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_webhooks(
          merchantId :: String.t(),
          body :: Adyen.Management.CreateMerchantWebhookRequest.t(),
          opts :: keyword
        ) :: {:ok, Adyen.Management.Webhook.t()} | {:error, Adyen.Management.RestServiceError.t()}
  def post_merchants_merchant_id_webhooks(merchantId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Management.WebhooksMerchantLevel, :post_merchants_merchant_id_webhooks},
      url: "/merchants/#{merchantId}/webhooks",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.CreateMerchantWebhookRequest, :t}}],
      response: [
        {200, {Adyen.Management.Webhook, :t}},
        {204, :null},
        {400, {Adyen.Management.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_webhooks_webhook_id_test(
          merchantId :: String.t(),
          webhookId :: String.t(),
          body :: Adyen.Management.TestWebhookRequest.t(),
          opts :: keyword
        ) ::
  ...
  def post_merchants_merchant_id_webhooks_webhook_id_test(merchantId, webhookId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.TestWebhookRequest, :t}}],
      response: [
