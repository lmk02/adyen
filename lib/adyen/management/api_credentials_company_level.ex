defmodule Adyen.Management.APICredentialsCompanyLevel do
  @moduledoc """
  ...
  * Management API—API credentials read and write
  ...
  @spec get_companies_company_id_api_credentials(companyId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Management.ListCompanyApiCredentialsResponse.t()}
  ...
  def get_companies_company_id_api_credentials(companyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.APICredentialsCompanyLevel, :get_companies_company_id_api_credentials},
      url: "/companies/#{companyId}/apiCredentials",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.Management.ListCompanyApiCredentialsResponse, :t}},
  ...
  * Management API—API credentials read and write
  ...
  @spec get_companies_company_id_api_credentials_api_credential_id(
          ...
          {:ok, Adyen.Management.CompanyApiCredential.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_companies_company_id_api_credentials_api_credential_id(
          companyId :: String.t(),
          apiCredentialId :: String.t(),
          body :: Adyen.Management.UpdateCompanyApiCredentialRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Management.CompanyApiCredential.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
  def patch_companies_company_id_api_credentials_api_credential_id(
    ...
    client.request(%{
      ...
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.Management.UpdateCompanyApiCredentialRequest, :t}}],
      response: [
        {200, {Adyen.Management.CompanyApiCredential, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_companies_company_id_api_credentials(
          companyId :: String.t(),
          body :: Adyen.Management.CreateCompanyApiCredentialRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Management.CreateCompanyApiCredentialResponse.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
  def post_companies_company_id_api_credentials(companyId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.APICredentialsCompanyLevel, :post_companies_company_id_api_credentials},
      url: "/companies/#{companyId}/apiCredentials",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.CreateCompanyApiCredentialRequest, :t}}],
      response: [
        {200, {Adyen.Management.CreateCompanyApiCredentialResponse, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
        {422, {Adyen.Management.RestServiceError, :t}},
