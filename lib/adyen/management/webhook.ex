defmodule Adyen.Management.Webhook do
  @moduledoc """
  Provides struct and type for a Webhook
  """

  @type t :: %__MODULE__{
          _links: Adyen.Management.WebhookLinks.t() | nil,
          ...
          active: boolean,
          additionalSettings: Adyen.Management.AdditionalSettingsResponse.t() | nil,
