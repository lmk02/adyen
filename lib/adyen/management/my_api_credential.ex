defmodule Adyen.Management.MyAPICredential do
  @moduledoc """
  ...
  def delete_me_allowed_origins_origin_id(originId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Management.MyAPICredential, :delete_me_allowed_origins_origin_id},
  ...
  @spec get_me(opts :: keyword) ::
          {:ok, Adyen.Management.MeApiCredential.t()}
  ...
  def get_me(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.Management.MyAPICredential, :get_me},
      url: "/me",
      method: :get,
      response: [
        {200, {Adyen.Management.MeApiCredential, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
        {422, {Adyen.Management.RestServiceError, :t}},
  ...
  def get_me_allowed_origins(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.Management.MyAPICredential, :get_me_allowed_origins},
  ...
  def get_me_allowed_origins_origin_id(originId, opts \\ []) do
    ...
    client.request(%{
      args: [originId: originId],
      call: {Adyen.Management.MyAPICredential, :get_me_allowed_origins_origin_id},
      url: "/me/allowedOrigins/#{originId}",
      method: :get,
      response: [
  ...
  **Content Types**: `application/json`
  ...
  @spec post_me_allowed_origins(
          body :: Adyen.Management.CreateAllowedOriginRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Management.AllowedOrigin.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
  def post_me_allowed_origins(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Management.MyAPICredential, :post_me_allowed_origins},
      url: "/me/allowedOrigins",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.CreateAllowedOriginRequest, :t}}],
      response: [
        {200, {Adyen.Management.AllowedOrigin, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
  ...
  * Management API—API credentials read and write
  ...
  def post_me_generate_client_key(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.Management.MyAPICredential, :post_me_generate_client_key},
