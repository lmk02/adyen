defmodule Adyen.Management.AccountMerchantLevel do
  @moduledoc """
  ...
  * Management API—Account read
  ...
  def get_merchants(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.Management.AccountMerchantLevel, :get_merchants},
      url: "/merchants",
      method: :get,
      query: query,
      response: [
  ...
  * Management API—Account read
  ...
  @spec get_merchants_merchant_id(merchantId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Management.Merchant.t()} | {:error, Adyen.Management.RestServiceError.t()}
  def get_merchants_merchant_id(merchantId, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [merchantId: merchantId],
      call: {Adyen.Management.AccountMerchantLevel, :get_merchants_merchant_id},
      url: "/merchants/#{merchantId}",
      method: :get,
      response: [
        {200, {Adyen.Management.Merchant, :t}},
        {204, :null},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_merchants(body :: Adyen.Management.CreateMerchantRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Management.CreateMerchantResponse.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
  def post_merchants(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Management.AccountMerchantLevel, :post_merchants},
      url: "/merchants",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.CreateMerchantRequest, :t}}],
      response: [
        {200, {Adyen.Management.CreateMerchantResponse, :t}},
        {204, :null},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
  ...
  * Management API—Accounts read and write
  ...
  @spec post_merchants_merchant_id_activate(merchantId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Management.RequestActivationResponse.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
  def post_merchants_merchant_id_activate(merchantId, opts \\ []) do
    ...
    client.request(%{
      args: [merchantId: merchantId],
      call: {Adyen.Management.AccountMerchantLevel, :post_merchants_merchant_id_activate},
      url: "/merchants/#{merchantId}/activate",
      method: :post,
      response: [
        {200, {Adyen.Management.RequestActivationResponse, :t}},
        {204, :null},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
