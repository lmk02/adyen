defmodule Adyen.Management.TerminalOrdersCompanyLevel do
  @moduledoc """
  ...
  * Management API—Terminal ordering read and write
  ...
  def get_companies_company_id_billing_entities(companyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.TerminalOrdersCompanyLevel, :get_companies_company_id_billing_entities},
  ...
  * Management API—Terminal ordering read and write
  ...
  def get_companies_company_id_shipping_locations(companyId, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId],
      call:
        {Adyen.Management.TerminalOrdersCompanyLevel,
  ...
  * Management API—Terminal ordering read and write
  ...
  def get_companies_company_id_terminal_models(companyId, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId],
      call:
        {Adyen.Management.TerminalOrdersCompanyLevel, :get_companies_company_id_terminal_models},
  ...
  * Management API—Terminal ordering read and write
  ...
  def get_companies_company_id_terminal_orders(companyId, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId],
      call:
        {Adyen.Management.TerminalOrdersCompanyLevel, :get_companies_company_id_terminal_orders},
  ...
  * Management API—Terminal ordering read and write
  ...
  In the live environment, requests to this endpoint are subject to [rate limits](https://docs.adyen.com/point-of-sale/automating-terminal-management#rate-limits-in-the-live-environment).
  """
  @spec get_companies_company_id_terminal_orders_order_id(
          companyId :: String.t(),
          orderId :: String.t(),
          opts :: keyword
        ) ::
  ...
  * Management API—Terminal ordering read and write
  ...
  ## Options
    ...
    * `terminalModelId`: The terminal model to return products for. Use the ID returned in the [GET `/terminalModels`](https://docs.adyen.com/api-explorer/#/ManagementService/latest/get/companies/{companyId}/terminalModels) response. For example, **Verifone.M400**
  ...
  def get_companies_company_id_terminal_products(companyId, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId],
      call:
        {Adyen.Management.TerminalOrdersCompanyLevel, :get_companies_company_id_terminal_products},
  ...
  **Content Types**: `application/json`
  ...
  def post_companies_company_id_terminal_orders(companyId, body, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId, body: body],
      call:
        {Adyen.Management.TerminalOrdersCompanyLevel, :post_companies_company_id_terminal_orders},
      url: "/companies/#{companyId}/terminalOrders",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.TerminalOrderRequest, :t}}],
  ...
  * Management API—Terminal ordering read and write
  ...
  In the live environment, requests to this endpoint are subject to [rate limits](https://docs.adyen.com/point-of-sale/automating-terminal-management#rate-limits-in-the-live-environment).
  """
  @spec post_companies_company_id_terminal_orders_order_id_cancel(
          companyId :: String.t(),
          orderId :: String.t(),
          opts :: keyword
        ) ::
