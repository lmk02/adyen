defmodule Adyen.Management.WebhooksCompanyLevel do
  @moduledoc """
  ...
  * Management API—Webhooks read and write
  ...
  def delete_companies_company_id_webhooks_webhook_id(companyId, webhookId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.WebhooksCompanyLevel, :delete_companies_company_id_webhooks_webhook_id},
  ...
  * Management API—Webhooks read and write
  ...
  @spec get_companies_company_id_webhooks(companyId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Management.ListWebhooksResponse.t()}
  ...
  def get_companies_company_id_webhooks(companyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Management.WebhooksCompanyLevel, :get_companies_company_id_webhooks},
      url: "/companies/#{companyId}/webhooks",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.Management.ListWebhooksResponse, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
        {422, {Adyen.Management.RestServiceError, :t}},
  ...
  * Management API—Webhooks read and write
  ...
  @spec get_companies_company_id_webhooks_webhook_id(
          ...
          webhookId :: String.t(),
          opts :: keyword
        ) :: {:ok, Adyen.Management.Webhook.t()} | {:error, Adyen.Management.RestServiceError.t()}
  def get_companies_company_id_webhooks_webhook_id(companyId, webhookId, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId, webhookId: webhookId],
      call:
        {Adyen.Management.WebhooksCompanyLevel, :get_companies_company_id_webhooks_webhook_id},
      url: "/companies/#{companyId}/webhooks/#{webhookId}",
      method: :get,
      response: [
        {200, {Adyen.Management.Webhook, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
        {422, {Adyen.Management.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_companies_company_id_webhooks_webhook_id(
          companyId :: String.t(),
          webhookId :: String.t(),
          body :: Adyen.Management.UpdateCompanyWebhookRequest.t(),
          opts :: keyword
        ) :: {:ok, Adyen.Management.Webhook.t()} | {:error, Adyen.Management.RestServiceError.t()}
  def patch_companies_company_id_webhooks_webhook_id(companyId, webhookId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.WebhooksCompanyLevel, :patch_companies_company_id_webhooks_webhook_id},
      url: "/companies/#{companyId}/webhooks/#{webhookId}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.Management.UpdateCompanyWebhookRequest, :t}}],
      response: [
        {200, {Adyen.Management.Webhook, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_companies_company_id_webhooks(
          companyId :: String.t(),
          body :: Adyen.Management.CreateCompanyWebhookRequest.t(),
          opts :: keyword
        ) :: {:ok, Adyen.Management.Webhook.t()} | {:error, Adyen.Management.RestServiceError.t()}
  def post_companies_company_id_webhooks(companyId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Management.WebhooksCompanyLevel, :post_companies_company_id_webhooks},
      url: "/companies/#{companyId}/webhooks",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.CreateCompanyWebhookRequest, :t}}],
      response: [
        {200, {Adyen.Management.Webhook, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
  ...
  * Management API—Webhooks read and write
  ...
  @spec post_companies_company_id_webhooks_webhook_id_generate_hmac(
          ...
          {:ok, Adyen.Management.GenerateHmacKeyResponse.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
  ...
  **Content Types**: `application/json`
  ...
  @spec post_companies_company_id_webhooks_webhook_id_test(
          companyId :: String.t(),
          webhookId :: String.t(),
          body :: Adyen.Management.TestCompanyWebhookRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Management.TestWebhookResponse.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
  def post_companies_company_id_webhooks_webhook_id_test(companyId, webhookId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.TestCompanyWebhookRequest, :t}}],
      response: [
        {200, {Adyen.Management.TestWebhookResponse, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
        {422, {Adyen.Management.RestServiceError, :t}},
