defmodule Adyen.Management.UpdateSplitConfigurationLogicRequest do
  @moduledoc """
  Provides struct and type for a UpdateSplitConfigurationLogicRequest
  """

  @type t :: %__MODULE__{
          acquiringFees: String.t() | nil,
          additionalCommission: Adyen.Management.AdditionalCommission.t() | nil,
          ...
          commission: Adyen.Management.Commission.t(),
  ...
  def __fields__(:t) do
    [
      ...
      additionalCommission: {Adyen.Management.AdditionalCommission, :t},
