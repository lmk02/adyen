defmodule Adyen.Management.AndroidFilesCompanyLevel do
  @moduledoc """
  ...
  * Management API—Terminal actions read and write
  ...
  @spec get_companies_company_id_android_apps(companyId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Management.AndroidAppsResponse.t()}
  ...
  def get_companies_company_id_android_apps(companyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Management.AndroidFilesCompanyLevel, :get_companies_company_id_android_apps},
      url: "/companies/#{companyId}/androidApps",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.Management.AndroidAppsResponse, :t}},
  ...
  * Management API—Android files read and write
  ...
  @spec get_companies_company_id_android_apps_id(
          ...
          {:ok, Adyen.Management.AndroidApp.t()} | {:error, Adyen.Management.RestServiceError.t()}
  def get_companies_company_id_android_apps_id(companyId, id, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.AndroidFilesCompanyLevel, :get_companies_company_id_android_apps_id},
      url: "/companies/#{companyId}/androidApps/#{id}",
      method: :get,
      response: [
        {200, {Adyen.Management.AndroidApp, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
        {422, {Adyen.Management.RestServiceError, :t}},
  ...
  * Management API—Terminal actions read and write
  ...
  @spec get_companies_company_id_android_certificates(companyId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Management.AndroidCertificatesResponse.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
  def get_companies_company_id_android_certificates(companyId, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId],
      call:
        {Adyen.Management.AndroidFilesCompanyLevel,
         :get_companies_company_id_android_certificates},
      url: "/companies/#{companyId}/androidCertificates",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.Management.AndroidCertificatesResponse, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
        {422, {Adyen.Management.RestServiceError, :t}},
  ...
  * Management API—Android files read and write
  ...
  @spec patch_companies_company_id_android_apps_id(
          ...
          {:ok, Adyen.Management.ReprocessAndroidAppResponse.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
  def patch_companies_company_id_android_apps_id(companyId, id, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId, id: id],
      call:
        {Adyen.Management.AndroidFilesCompanyLevel, :patch_companies_company_id_android_apps_id},
      url: "/companies/#{companyId}/androidApps/#{id}",
      method: :patch,
      response: [
        {200, {Adyen.Management.ReprocessAndroidAppResponse, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
        {422, {Adyen.Management.RestServiceError, :t}},
  ...
  * Management API—Android files read and write
  ...
  @spec post_companies_company_id_android_apps(companyId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Management.UploadAndroidAppResponse.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
  def post_companies_company_id_android_apps(companyId, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId],
      call: {Adyen.Management.AndroidFilesCompanyLevel, :post_companies_company_id_android_apps},
      url: "/companies/#{companyId}/androidApps",
      method: :post,
      response: [
        {200, {Adyen.Management.UploadAndroidAppResponse, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
        {422, {Adyen.Management.RestServiceError, :t}},
  ...
  @spec post_companies_company_id_android_certificates(companyId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Management.UploadAndroidCertificateResponse.t()}
          | {:error, Adyen.Management.RestServiceError.t()}
  def post_companies_company_id_android_certificates(companyId, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :post,
      response: [
        {200, {Adyen.Management.UploadAndroidCertificateResponse, :t}},
        {400, {Adyen.Management.RestServiceError, :t}},
        {401, {Adyen.Management.RestServiceError, :t}},
        {403, {Adyen.Management.RestServiceError, :t}},
        {422, {Adyen.Management.RestServiceError, :t}},
