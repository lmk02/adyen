defmodule Adyen.Management.TerminalActionsTerminalLevel do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec post_terminals_schedule_actions(
          body :: Adyen.Management.ScheduleTerminalActionsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Management.ScheduleTerminalActionsResponse.t()}
  ...
  def post_terminals_schedule_actions(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Management.TerminalActionsTerminalLevel, :post_terminals_schedule_actions},
      url: "/terminals/scheduleActions",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.ScheduleTerminalActionsRequest, :t}}],
      response: [
        {200, {Adyen.Management.ScheduleTerminalActionsResponse, :t}},
