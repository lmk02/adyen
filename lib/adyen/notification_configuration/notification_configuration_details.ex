defmodule Adyen.NotificationConfiguration.NotificationConfigurationDetails do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          eventConfigs:
            [Adyen.NotificationConfiguration.NotificationEventConfiguration.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      description: :string,
      eventConfigs: [{Adyen.NotificationConfiguration.NotificationEventConfiguration, :t}],
