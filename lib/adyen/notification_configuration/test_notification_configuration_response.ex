defmodule Adyen.NotificationConfiguration.TestNotificationConfigurationResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          exchangeMessages: [Adyen.NotificationConfiguration.ExchangeMessage.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      exchangeMessages: [{Adyen.NotificationConfiguration.ExchangeMessage, :t}],
