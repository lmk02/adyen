defmodule Adyen.Payments.Payments do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_authorise(body :: Adyen.Payments.PaymentRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Payments.PaymentResult.t()} | {:error, Adyen.Payments.ServiceError.t()}
  def post_authorise(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Payments.Payments, :post_authorise},
      url: "/authorise",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payments.PaymentRequest, :t}}],
      response: [
        {200, {Adyen.Payments.PaymentResult, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_authorise3_d(body :: Adyen.Payments.PaymentRequest3D.t(), opts :: keyword) ::
          {:ok, Adyen.Payments.PaymentResult.t()} | {:error, Adyen.Payments.ServiceError.t()}
  def post_authorise3_d(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Payments.Payments, :post_authorise3_d},
      url: "/authorise3d",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payments.PaymentRequest3D, :t}}],
      response: [
        {200, {Adyen.Payments.PaymentResult, :t}},
        {400, {Adyen.Payments.ServiceError, :t}},
        {401, {Adyen.Payments.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_authorise3_ds2(body :: Adyen.Payments.PaymentRequest3Ds2.t(), opts :: keyword) ::
          {:ok, Adyen.Payments.PaymentResult.t()} | {:error, Adyen.Payments.ServiceError.t()}
  def post_authorise3_ds2(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Payments.Payments, :post_authorise3_ds2},
      url: "/authorise3ds2",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payments.PaymentRequest3Ds2, :t}}],
      response: [
        {200, {Adyen.Payments.PaymentResult, :t}},
        {400, {Adyen.Payments.ServiceError, :t}},
        {401, {Adyen.Payments.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_get_authentication_result(
          body :: Adyen.Payments.AuthenticationResultRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Payments.AuthenticationResultResponse.t()}
          | {:error, Adyen.Payments.ServiceError.t()}
  def post_get_authentication_result(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Payments.Payments, :post_get_authentication_result},
      url: "/getAuthenticationResult",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payments.AuthenticationResultRequest, :t}}],
      response: [
        {200, {Adyen.Payments.AuthenticationResultResponse, :t}},
        {400, {Adyen.Payments.ServiceError, :t}},
        {401, {Adyen.Payments.ServiceError, :t}},
        {403, {Adyen.Payments.ServiceError, :t}},
        {422, {Adyen.Payments.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_retrieve3_ds2_result(
          body :: Adyen.Payments.ThreeDs2ResultRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Payments.ThreeDs2ResultResponse.t()}
          | {:error, Adyen.Payments.ServiceError.t()}
  def post_retrieve3_ds2_result(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Payments.Payments, :post_retrieve3_ds2_result},
      url: "/retrieve3ds2Result",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payments.ThreeDs2ResultRequest, :t}}],
      response: [
        {200, {Adyen.Payments.ThreeDs2ResultResponse, :t}},
        {400, {Adyen.Payments.ServiceError, :t}},
        {401, {Adyen.Payments.ServiceError, :t}},
        {403, {Adyen.Payments.ServiceError, :t}},
        {422, {Adyen.Payments.ServiceError, :t}},
