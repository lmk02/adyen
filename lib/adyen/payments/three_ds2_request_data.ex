defmodule Adyen.Payments.ThreeDs2RequestData do
  @moduledoc """
  Provides struct and type for a ThreeDs2RequestData
  """

  @type t :: %__MODULE__{
          acctInfo: Adyen.Payments.AcctInfo.t() | nil,
          ...
          deviceRenderOptions: Adyen.Payments.DeviceRenderOptions.t() | nil,
          homePhone: Adyen.Payments.Phone.t() | nil,
          mcc: String.t() | nil,
          merchantName: String.t() | nil,
          messageVersion: String.t() | nil,
          mobilePhone: Adyen.Payments.Phone.t() | nil,
          ...
          sdkEphemPubKey: Adyen.Payments.SDKEphemPubKey.t() | nil,
  ...
  def __fields__(:t) do
    [
      acctInfo: {Adyen.Payments.AcctInfo, :t},
      ...
      deviceRenderOptions: {Adyen.Payments.DeviceRenderOptions, :t},
      homePhone: {Adyen.Payments.Phone, :t},
      mcc: :string,
      merchantName: :string,
      messageVersion: :string,
      mobilePhone: {Adyen.Payments.Phone, :t},
      ...
      sdkAppID: :string,
      sdkEncData: :string,
      sdkEphemPubKey: {Adyen.Payments.SDKEphemPubKey, :t},
      ...
      threeDSRequestorAuthenticationInfo: {Adyen.Payments.ThreeDSRequestorAuthenticationInfo, :t},
      threeDSRequestorChallengeInd: {:enum, ["01", "02", "03", "04", "05", "06"]},
      threeDSRequestorID: :string,
      threeDSRequestorName: :string,
      threeDSRequestorPriorAuthenticationInfo:
        {Adyen.Payments.ThreeDSRequestorPriorAuthenticationInfo, :t},
      ...
      workPhone: {Adyen.Payments.Phone, :t}
    ]
  end
end
