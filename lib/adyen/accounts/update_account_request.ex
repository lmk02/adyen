defmodule Adyen.Accounts.UpdateAccountRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          payoutSchedule: Adyen.Accounts.UpdatePayoutScheduleRequest.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      payoutSchedule: {Adyen.Accounts.UpdatePayoutScheduleRequest, :t},
