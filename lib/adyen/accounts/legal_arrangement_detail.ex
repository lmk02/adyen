defmodule Adyen.Accounts.LegalArrangementDetail do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          legalArrangementEntities: [Adyen.Accounts.LegalArrangementEntityDetail.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      legalArrangementEntities: [{Adyen.Accounts.LegalArrangementEntityDetail, :t}],
