defmodule Adyen.Capital.GrantOffers do
  @moduledoc """
  ...
  @spec get_grant_offers(opts :: keyword) ::
          {:ok, Adyen.Capital.GrantOffers.t()}
  ...
  def get_grant_offers(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.Capital.GrantOffers, :get_grant_offers},
      url: "/grantOffers",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.Capital.GrantOffers, :t}},
  ...
  def get_grant_offers_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.Capital.GrantOffers, :get_grant_offers_id},
      url: "/grantOffers/#{id}",
      method: :get,
      response: [
  ...
  @type t :: %__MODULE__{grantOffers: [Adyen.Capital.GrantOffer.t()]}
  ...
  def __fields__(:t) do
    [grantOffers: [{Adyen.Capital.GrantOffer, :t}]]
  end
end
