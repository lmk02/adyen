defmodule Adyen.LegalEntity.LegalEntities do
  @moduledoc """
  ...
  @spec get_legal_entities_id(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.LegalEntity.t()} | {:error, Adyen.LegalEntity.ServiceError.t()}
  def get_legal_entities_id(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.LegalEntities, :get_legal_entities_id},
      url: "/legalEntities/#{id}",
      method: :get,
      response: [
        {200, {Adyen.LegalEntity.LegalEntity, :t}},
  ...
  @spec get_legal_entities_id_business_lines(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.BusinessLines.t()}
  ...
  def get_legal_entities_id_business_lines(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.LegalEntities, :get_legal_entities_id_business_lines},
      url: "/legalEntities/#{id}/businessLines",
      method: :get,
      response: [
        {200, {Adyen.LegalEntity.BusinessLines, :t}},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
        {401, {Adyen.LegalEntity.ServiceError, :t}},
        {403, {Adyen.LegalEntity.ServiceError, :t}},
        {422, {Adyen.LegalEntity.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_legal_entities_id(
          id :: String.t(),
          body :: Adyen.LegalEntity.LegalEntityInfo.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.LegalEntity.LegalEntity.t()} | {:error, Adyen.LegalEntity.ServiceError.t()}
  def patch_legal_entities_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.LegalEntity.LegalEntities, :patch_legal_entities_id},
      url: "/legalEntities/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.LegalEntity.LegalEntityInfo, :t}}],
      response: [
        {200, {Adyen.LegalEntity.LegalEntity, :t}},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
        {401, {Adyen.LegalEntity.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_legal_entities(
          body :: Adyen.LegalEntity.LegalEntityInfoRequiredType.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.LegalEntity.LegalEntity.t()} | {:error, Adyen.LegalEntity.ServiceError.t()}
  def post_legal_entities(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.LegalEntity.LegalEntities, :post_legal_entities},
      url: "/legalEntities",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.LegalEntity.LegalEntityInfoRequiredType, :t}}],
      response: [
        {200, {Adyen.LegalEntity.LegalEntity, :t}},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
        {401, {Adyen.LegalEntity.ServiceError, :t}},
  ...
  @spec post_legal_entities_id_check_verification_errors(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.VerificationErrors.t()}
          | {:error, Adyen.LegalEntity.ServiceError.t()}
  def post_legal_entities_id_check_verification_errors(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.LegalEntities, :post_legal_entities_id_check_verification_errors},
      url: "/legalEntities/#{id}/checkVerificationErrors",
      method: :post,
      response: [
        {200, {Adyen.LegalEntity.VerificationErrors, :t}},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
        {401, {Adyen.LegalEntity.ServiceError, :t}},
        {403, {Adyen.LegalEntity.ServiceError, :t}},
        {422, {Adyen.LegalEntity.ServiceError, :t}},
  ...
  @spec post_legal_entities_id_confirm_data_review(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.DataReviewConfirmationResponse.t()}
          | {:error, Adyen.LegalEntity.ServiceError.t()}
  def post_legal_entities_id_confirm_data_review(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.LegalEntities, :post_legal_entities_id_confirm_data_review},
      url: "/legalEntities/#{id}/confirmDataReview",
      method: :post,
      response: [
        {200, {Adyen.LegalEntity.DataReviewConfirmationResponse, :t}},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
        {401, {Adyen.LegalEntity.ServiceError, :t}},
        {403, {Adyen.LegalEntity.ServiceError, :t}},
        {422, {Adyen.LegalEntity.ServiceError, :t}},
  ...
  def post_legal_entities_id_request_periodic_review(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.LegalEntities, :post_legal_entities_id_request_periodic_review},
