defmodule Adyen.LegalEntity.Documents do
  @moduledoc """
  ...
  def delete_documents_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.Documents, :delete_documents_id},
      url: "/documents/#{id}",
      method: :delete,
      response: [
        {204, :null},
  ...
  @spec get_documents_id(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.Document.t()} | {:error, Adyen.LegalEntity.ServiceError.t()}
  def get_documents_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.Documents, :get_documents_id},
      url: "/documents/#{id}",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.LegalEntity.Document, :t}},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
        {401, {Adyen.LegalEntity.ServiceError, :t}},
        {403, {Adyen.LegalEntity.ServiceError, :t}},
        {422, {Adyen.LegalEntity.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_documents_id(
          id :: String.t(),
          body :: Adyen.LegalEntity.Document.t(),
          opts :: keyword
        ) :: {:ok, Adyen.LegalEntity.Document.t()} | {:error, Adyen.LegalEntity.ServiceError.t()}
  def patch_documents_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.LegalEntity.Documents, :patch_documents_id},
      url: "/documents/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.LegalEntity.Document, :t}}],
      response: [
        {200, {Adyen.LegalEntity.Document, :t}},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
        {401, {Adyen.LegalEntity.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_documents(body :: Adyen.LegalEntity.Document.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.Document.t()} | {:error, Adyen.LegalEntity.ServiceError.t()}
  def post_documents(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.LegalEntity.Documents, :post_documents},
      url: "/documents",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.LegalEntity.Document, :t}}],
