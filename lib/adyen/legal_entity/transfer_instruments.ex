defmodule Adyen.LegalEntity.TransferInstruments do
  @moduledoc """
  ...
  def delete_transfer_instruments_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.TransferInstruments, :delete_transfer_instruments_id},
  ...
  @spec get_transfer_instruments_id(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.TransferInstrument.t()}
  ...
  def get_transfer_instruments_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.TransferInstruments, :get_transfer_instruments_id},
      url: "/transferInstruments/#{id}",
      method: :get,
      response: [
        {200, {Adyen.LegalEntity.TransferInstrument, :t}},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
        {401, {Adyen.LegalEntity.ServiceError, :t}},
        {403, {Adyen.LegalEntity.ServiceError, :t}},
        {422, {Adyen.LegalEntity.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_transfer_instruments_id(
          id :: String.t(),
          body :: Adyen.LegalEntity.TransferInstrumentInfo.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.LegalEntity.TransferInstrument.t()}
          | {:error, Adyen.LegalEntity.ServiceError.t()}
  def patch_transfer_instruments_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.LegalEntity.TransferInstruments, :patch_transfer_instruments_id},
      url: "/transferInstruments/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.LegalEntity.TransferInstrumentInfo, :t}}],
      response: [
        {200, {Adyen.LegalEntity.TransferInstrument, :t}},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
        {401, {Adyen.LegalEntity.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  def post_transfer_instruments(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.LegalEntity.TransferInstruments, :post_transfer_instruments},
