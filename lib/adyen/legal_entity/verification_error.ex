defmodule Adyen.LegalEntity.VerificationError do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          remediatingActions: [Adyen.LegalEntity.RemediatingAction.t()] | nil,
          subErrors: [Adyen.LegalEntity.VerificationErrorRecursive.t()] | nil,
          type: String.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      code: :string,
      message: :string,
      remediatingActions: [{Adyen.LegalEntity.RemediatingAction, :t}],
      subErrors: [{Adyen.LegalEntity.VerificationErrorRecursive, :t}],
