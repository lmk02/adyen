defmodule Adyen.LegalEntity.Trust do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          type: String.t(),
          undefinedBeneficiaryInfo: [Adyen.LegalEntity.UndefinedBeneficiary.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      undefinedBeneficiaryInfo: [{Adyen.LegalEntity.UndefinedBeneficiary, :t}],
