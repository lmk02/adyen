defmodule Adyen.LegalEntity.BusinessLines do
  @moduledoc """
  ...
  @spec delete_business_lines_id(id :: String.t(), opts :: keyword) ::
          :ok | {:error, Adyen.LegalEntity.ServiceError.t()}
  def delete_business_lines_id(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.BusinessLines, :delete_business_lines_id},
  ...
  @spec get_business_lines_id(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.BusinessLine.t()} | {:error, Adyen.LegalEntity.ServiceError.t()}
  def get_business_lines_id(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.BusinessLines, :get_business_lines_id},
      url: "/businessLines/#{id}",
      method: :get,
      response: [
        {200, {Adyen.LegalEntity.BusinessLine, :t}},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
        {401, {Adyen.LegalEntity.ServiceError, :t}},
        {403, {Adyen.LegalEntity.ServiceError, :t}},
        {422, {Adyen.LegalEntity.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_business_lines_id(
          id :: String.t(),
          body :: Adyen.LegalEntity.BusinessLineInfoUpdate.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.LegalEntity.BusinessLine.t()} | {:error, Adyen.LegalEntity.ServiceError.t()}
  def patch_business_lines_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.LegalEntity.BusinessLines, :patch_business_lines_id},
      url: "/businessLines/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.LegalEntity.BusinessLineInfoUpdate, :t}}],
      response: [
        {200, {Adyen.LegalEntity.BusinessLine, :t}},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
        {401, {Adyen.LegalEntity.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_business_lines(body :: Adyen.LegalEntity.BusinessLineInfo.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.BusinessLine.t()} | {:error, Adyen.LegalEntity.ServiceError.t()}
  def post_business_lines(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.LegalEntity.BusinessLines, :post_business_lines},
      url: "/businessLines",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.LegalEntity.BusinessLineInfo, :t}}],
      response: [
        {200, {Adyen.LegalEntity.BusinessLine, :t}},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
        {401, {Adyen.LegalEntity.ServiceError, :t}},
  ...
  @type t :: %__MODULE__{businessLines: [Adyen.LegalEntity.BusinessLine.t()]}
  ...
  def __fields__(:t) do
    [businessLines: [{Adyen.LegalEntity.BusinessLine, :t}]]
  end
end
