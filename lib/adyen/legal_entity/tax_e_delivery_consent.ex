defmodule Adyen.LegalEntity.TaxEDeliveryConsent do
  @moduledoc """
  ...
  @spec post_legal_entities_id_check_tax_electronic_delivery_consent(
          ...
          {:ok, Adyen.LegalEntity.CheckTaxElectronicDeliveryConsentResponse.t()}
  ...
  **Content Types**: `application/json`
  ...
  @spec post_legal_entities_id_set_tax_electronic_delivery_consent(
          id :: String.t(),
          body :: Adyen.LegalEntity.SetTaxElectronicDeliveryConsentRequest.t(),
          opts :: keyword
  ...
  def post_legal_entities_id_set_tax_electronic_delivery_consent(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :post,
      request: [
        {"application/json", {Adyen.LegalEntity.SetTaxElectronicDeliveryConsentRequest, :t}}
      ],
      response: [
        {200, :null},
        {400, {Adyen.LegalEntity.ServiceError, :t}},
