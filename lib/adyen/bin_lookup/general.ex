defmodule Adyen.BinLookup.General do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec post_get3_ds_availability(
          body :: Adyen.BinLookup.ThreeDSAvailabilityRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.BinLookup.ThreeDSAvailabilityResponse.t()}
          | {:error, Adyen.BinLookup.ServiceError.t()}
  def post_get3_ds_availability(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.BinLookup.General, :post_get3_ds_availability},
      url: "/get3dsAvailability",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.BinLookup.ThreeDSAvailabilityRequest, :t}}],
      response: [
        {200, {Adyen.BinLookup.ThreeDSAvailabilityResponse, :t}},
        {400, {Adyen.BinLookup.ServiceError, :t}},
        {401, {Adyen.BinLookup.ServiceError, :t}},
        {403, {Adyen.BinLookup.ServiceError, :t}},
        {422, {Adyen.BinLookup.ServiceError, :t}},
        {500, {Adyen.BinLookup.ServiceError, :t}}
      ],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  """
  @spec post_get_cost_estimate(body :: Adyen.BinLookup.CostEstimateRequest.t(), opts :: keyword) ::
          {:ok, Adyen.BinLookup.CostEstimateResponse.t()}
          | {:error, Adyen.BinLookup.ServiceError.t()}
  def post_get_cost_estimate(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.BinLookup.General, :post_get_cost_estimate},
      url: "/getCostEstimate",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.BinLookup.CostEstimateRequest, :t}}],
      response: [
        {200, {Adyen.BinLookup.CostEstimateResponse, :t}},
        {400, {Adyen.BinLookup.ServiceError, :t}},
        {401, {Adyen.BinLookup.ServiceError, :t}},
        {403, {Adyen.BinLookup.ServiceError, :t}},
        {422, {Adyen.BinLookup.ServiceError, :t}},
