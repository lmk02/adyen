defmodule Adyen.BalancePlatform.ManageSCADevices do
  ...
  def delete_registered_device(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.BalancePlatform.ManageSCADevices, :delete_registered_device},
  ...
  **Content Types**: `application/json`
  ...
  def update_registered_device_id_associations(deviceId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.BalancePlatform.ManageSCADevices, :update_registered_device_id_associations},
  ...
  **Content Types**: `application/json`
  ...
  def update_registered_device(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.BalancePlatform.ManageSCADevices, :update_registered_device},
      url: "/registeredDevices/#{id}",
      body: body,
      method: :patch,
  ...
  **Content Types**: `application/json`
  ...
  def create_registered_devices(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.BalancePlatform.ManageSCADevices, :create_registered_devices},
      url: "/registeredDevices",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.BalancePlatform.RegisterSCARequest, :t}}],
  ...
  **Content Types**: `application/json`
  ...
  def create_registered_device_id_associations(deviceId, body, opts \\ []) do
    ...
    client.request(%{
      args: [deviceId: deviceId, body: body],
      call:
        {Adyen.BalancePlatform.ManageSCADevices, :create_registered_device_id_associations},
      url: "/registeredDevices/#{deviceId}/associations",
      body: body,
      method: :post,
