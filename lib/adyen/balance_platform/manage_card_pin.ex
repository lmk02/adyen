defmodule Adyen.BalancePlatform.ManageCardPIN do
  ...
  **Content Types**: `application/json`
  """
  @spec post_pins_change(body :: Adyen.BalancePlatform.PinChangeRequest.t(), opts :: keyword) ::
  ...
  def post_pins_change(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.BalancePlatform.ManageCardPIN, :post_pins_change},
      url: "/pins/change",
      body: body,
      method: :post,
  ...
  **Content Types**: `application/json`
  """
  @spec post_pins_reveal(body :: Adyen.BalancePlatform.RevealPinRequest.t(), opts :: keyword) ::
  ...
  def post_pins_reveal(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.BalancePlatform.ManageCardPIN, :post_pins_reveal},
      url: "/pins/reveal",
      body: body,
      method: :post,
