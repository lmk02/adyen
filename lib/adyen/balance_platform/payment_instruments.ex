defmodule Adyen.BalancePlatform.PaymentInstruments do
  ...
  def get_payment_instrument(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.BalancePlatform.PaymentInstruments, :get_payment_instrument},
    ...
    client.request(%{
      ...
      call:
        {Adyen.BalancePlatform.PaymentInstruments,
         :get_payment_instrument_network_token_activation_data},
  ...
  def get_payment_instrument_network_tokens(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call:
        {Adyen.BalancePlatform.PaymentInstruments, :get_payment_instrument_network_tokens},
  ...
  * Balance Platform BCL PCI role
  ...
  def get_payment_instrument_reveal(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.BalancePlatform.PaymentInstruments, :get_payment_instrument_reveal},
  ...
  def get_payment_instrument_transaction_rules(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call:
        {Adyen.BalancePlatform.PaymentInstruments, :get_payment_instrument_transaction_rules},
  ...
  **Content Types**: `application/json`
  ...
  def update_payment_instrument(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.BalancePlatform.PaymentInstruments, :update_payment_instrument},
      url: "/paymentInstruments/#{id}",
      body: body,
      method: :patch,
  ...
  **Content Types**: `application/json`
  ...
  def create_payment_instruments(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.BalancePlatform.PaymentInstruments, :create_payment_instruments},
  ...
  **Content Types**: `application/json`
  ...
  def create_payment_instrument_network_token_activation_data(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.BalancePlatform.PaymentInstruments,
         :create_payment_instrument_network_token_activation_data},
      url: "/paymentInstruments/#{id}/networkTokenActivationData",
      body: body,
      method: :post,
      request: [
  ...
  **Content Types**: `application/json`
  ...
  def create_payment_instruments_reveal(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.BalancePlatform.PaymentInstruments, :create_payment_instruments_reveal},
