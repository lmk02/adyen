defmodule Adyen.Transfers.Capital do
  ...
  def get_grants_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.Transfers.Capital, :get_grants_id},
      url: "/grants/#{id}",
      method: :get,
      response: [
  ...
  **Content Types**: `application/json`
  """
  @spec post_grants(body :: Adyen.Transfers.CapitalGrantInfo.t(), opts :: keyword) ::
          {:ok, Adyen.Transfers.CapitalGrant.t()} | {:error, Adyen.Transfers.RestServiceError.t()}
  def post_grants(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Transfers.Capital, :post_grants},
      url: "/grants",
      body: body,
      method: :post,
