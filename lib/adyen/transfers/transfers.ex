defmodule Adyen.Transfers.Transfers do
  ...
  def get_transfer(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.Transfers.Transfers, :get_transfer},
      url: "/transfers/#{id}",
      method: :get,
      response: [
  ...
  **Content Types**: `application/json`
  """
  @spec create_transfer(body :: Adyen.Transfers.TransferInfo.t(), opts :: keyword) ::
  ...
  def create_transfer(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Transfers.Transfers, :create_transfer},
      url: "/transfers",
      body: body,
      method: :post,
  ...
  **Content Types**: `application/json`
  ...
  def create_transfers_approve(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Transfers.Transfers, :create_transfers_approve},
  ...
  **Content Types**: `application/json`
  """
  @spec create_transfers_cancel(body :: Adyen.Transfers.CancelTransfersRequest.t(), opts :: keyword) ::
  ...
  def create_transfers_cancel(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Transfers.Transfers, :create_transfers_cancel},
  ...
  **Content Types**: `application/json`
  ...
  def create_transfer_id_returns(transferId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Transfers.Transfers, :create_transfer_id_returns},
