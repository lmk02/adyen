defmodule Adyen.Transaction.RaiseDisputes do
  @moduledoc """
  ...
  @spec get_disputes(opts :: keyword) ::
          {:ok, [[Adyen.Transaction.DisputeResponse.t()]]}
  ...
  def get_disputes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.Transaction.RaiseDisputes, :get_disputes},
      url: "/disputes",
      method: :get,
      query: query,
      response: [
        {200, [[{Adyen.Transaction.DisputeResponse, :t}]]},
  ...
  def get_disputes_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.Transaction.RaiseDisputes, :get_disputes_id},
      url: "/disputes/#{id}",
      method: :get,
      response: [
        {200, {Adyen.Transaction.DisputeResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_disputes_id(
          id :: String.t(),
          body :: Adyen.Transaction.PatchableDisputeRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Transaction.DisputeResponse.t()}
          | {:error, Adyen.Transaction.DefaultErrorResponseEntity.t()}
  def patch_disputes_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Transaction.RaiseDisputes, :patch_disputes_id},
      url: "/disputes/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.Transaction.PatchableDisputeRequest, :t}}],
      response: [
        {200, {Adyen.Transaction.DisputeResponse, :t}},
        {401, {Adyen.Transaction.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.Transaction.DefaultErrorResponseEntity, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_disputes(body :: Adyen.Transaction.DisputeRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Transaction.DisputeResponse.t()}
          | {:error, Adyen.Transaction.DefaultErrorResponseEntity.t()}
  def post_disputes(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Transaction.RaiseDisputes, :post_disputes},
      url: "/disputes",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Transaction.DisputeRequest, :t}}],
      response: [
        {200, {Adyen.Transaction.DisputeResponse, :t}},
        {401, {Adyen.Transaction.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.Transaction.DefaultErrorResponseEntity, :t}},
